...
namespace Ellucian.Generated.BpApi.Ban.StudentAdjustmentTargetsWaiversSubstitutionsWaiversV100PostResponse
{
    ...
    public partial class StudentAdjustmentTargetsWaiversSubstitutionsWaiversV100PostResponse
    {
        [Newtonsoft.Json.JsonProperty("smrswpv", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Smrswpv>? Smrswpv { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("smrswav", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Smrswav>? Smrswav { get; set; } = default!;
