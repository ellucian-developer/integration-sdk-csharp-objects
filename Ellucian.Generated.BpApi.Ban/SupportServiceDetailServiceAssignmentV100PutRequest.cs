...
namespace Ellucian.Generated.BpApi.Ban.SupportServiceDetailServiceAssignmentV100PutRequest
{
    ...
    public partial class SupportServiceDetailServiceAssignmentV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("serdtsrSsgpCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SerdtsrSsgpCode { get; set; } = default!;
        ...
        /// Lineage reference object : SERDTSR_SEPR_CODE, Lookup lineage reference object : stvsepr
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.seprCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSeprCode { get; set; } = default!;
        ...
        /// Lineage reference object : SERDTSR_SSEP_CODE, Lookup lineage reference object : stvssep
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.ssepCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSsepCode { get; set; } = default!;
        ...
        /// Lineage reference object : SERDTSR_SSER_CODE, Lookup lineage reference object : stvsser
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.sserCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaSserCode { get; set; } = default!;
        ...
        /// Lineage reference object : SERDTSR_SPRV_CODE, Lookup lineage reference object : stvsprv
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.sprvCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSprvCode { get; set; } = default!;
