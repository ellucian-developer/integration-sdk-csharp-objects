...
namespace Ellucian.Generated.BpApi.Ban.ComplianceResultsInquiryV010GetResponse
{
    ...
    public partial class ComplianceResultsInquiryV010GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("origName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OrigName { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("termCodeCatlg", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TermCodeCatlg { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("origId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OrigId { get; set; } = default!;
