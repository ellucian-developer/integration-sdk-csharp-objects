...
namespace Ellucian.Generated.BpApi.Ban.SectionRestrictionDegreeAndProgramV100GetResponse
{
    ...
    public partial class SectionRestrictionDegreeAndProgramV100GetResponse
    {
        [Newtonsoft.Json.JsonProperty("ssrrprg", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Ssrrprg>? Ssrrprg { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("ssrrdeg", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Ssrrdeg>? Ssrrdeg { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Ssrrdeg
    {
        [Newtonsoft.Json.JsonProperty("degreeDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DegreeDescription { get; set; } = default!;
