...
namespace Ellucian.Generated.BpApi.Ban.TranscriptEventsAndCommentsAcademicEventsV100PostResponse
{
    ...
    public partial class TranscriptEventsAndCommentsAcademicEventsV100PostResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("stvevenTransInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? StvevenTransInd { get; set; } = default!;
