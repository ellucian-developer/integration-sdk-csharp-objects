...
namespace Ellucian.Generated.BpApi.Ban.StudentRegistrationGroupV100GetResponse
{
    ...
    public partial class StudentRegistrationGroupV100GetResponse
    {
        [Newtonsoft.Json.JsonProperty("sfrwctl", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Sfrwctl>? Sfrwctl { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("sfbrgrp", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Sfbrgrp>? Sfbrgrp { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Sfbrgrp
    {
        /// <summary>
        /// Lineage reference object : SFBRGRP_RGRP_CODE, Lookup lineage reference object : sfbwctl,sfrwctl
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rgrpCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string RgrpCode { get; set; } = default!;
