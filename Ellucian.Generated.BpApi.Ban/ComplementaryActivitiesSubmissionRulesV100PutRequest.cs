...
namespace Ellucian.Generated.BpApi.Ban.ComplementaryActivitiesSubmissionRulesV100PutRequest
{
    ...
    public partial class ComplementaryActivitiesSubmissionRulesV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : SOBCASR_MIN_HRS
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.minHrs", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaMinHrs { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SOBCASR_ACTC_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.actcCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaActcCode { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("criteria.accgCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// Lineage reference object : SOBCASR_MAX_HRS
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.maxHrs", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaMaxHrs { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("criteria.actcDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaActcDesc { get; set; } = default!;
