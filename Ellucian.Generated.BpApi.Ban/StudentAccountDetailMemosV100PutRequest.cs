...
namespace Ellucian.Generated.BpApi.Ban.StudentAccountDetailMemosV100PutRequest
{
    ...
    public partial class StudentAccountDetailMemosV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : TBRMEMO_CREATE_USER
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.createUser", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCreateUser { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.billingInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaBillingInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.srceCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
