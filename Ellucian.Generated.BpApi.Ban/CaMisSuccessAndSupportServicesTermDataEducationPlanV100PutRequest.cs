...
namespace Ellucian.Generated.BpApi.Ban.CaMisSuccessAndSupportServicesTermDataEducationPlanV100PutRequest
{
    ...
    public partial class CaMisSuccessAndSupportServicesTermDataEducationPlanV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.epstCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaEpstCode { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("svredplId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SvredplId { get; set; } = default!;
        ...
        /// Lineage reference object : SVREDPL_DUPL_OVERRIDE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.duplOverrideInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaDuplOverrideInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SVREDPL_EPST_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("svredplEpstCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SvredplEpstCode { get; set; } = default!;
