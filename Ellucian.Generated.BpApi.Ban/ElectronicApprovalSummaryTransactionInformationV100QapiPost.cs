...
namespace Ellucian.Generated.BpApi.Ban.ElectronicApprovalSummaryTransactionInformationV100QapiPost
{
    ...
    public partial class ElectronicApprovalSummaryTransactionInformationV100QapiPost
    {
        ...
        public string? TransactionFromDate { get; set; } = default!;
        ...
        public string? TransactionToDate { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("holdQueueStatusInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? HoldQueueStatusInd { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("holdActionInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? HoldActionInd { get; set; } = default!;
