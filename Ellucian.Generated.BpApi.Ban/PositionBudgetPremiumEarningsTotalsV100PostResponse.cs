...
namespace Ellucian.Generated.BpApi.Ban.PositionBudgetPremiumEarningsTotalsV100PostResponse
{
    ...
    public partial class PositionBudgetPremiumEarningsTotalsV100PostResponse
    {
        /// <summary>
        /// Lineage reference object : NBRRTOT_BUDGET_TO_POST
        /// </summary>
        [Newtonsoft.Json.JsonProperty("budgetToPost", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? BudgetToPost { get; set; } = default!;
