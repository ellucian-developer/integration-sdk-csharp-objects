...
namespace Ellucian.Generated.BpApi.Ban.WebApplicationCustomizedLetterTypeCodesV100GetResponse
{
    ...
    public partial class WebApplicationCustomizedLetterTypeCodesV100GetResponse
    {
        /// <summary>
        /// Lineage reference object : STVWLTT_ELMT_CODE, Lookup lineage reference object : stvelmt
        /// </summary>
        [Newtonsoft.Json.JsonProperty("elmtCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ElmtCode { get; set; } = default!;
