...
namespace Ellucian.Generated.BpApi.Ban.PayrollIdentificationCodeRuleV100GetResponse
{
    ...
    public partial class PayrollIdentificationCodeRuleV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("pictBankName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PictBankName { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("tsAmPmInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string TsAmPmInd { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("tsAprAmPmInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string TsAprAmPmInd { get; set; } = default!;
