...
namespace Ellucian.Generated.BpApi.Ban.PersonCommentsV100PutRequest
{
    ...
    public partial class PersonCommentsV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.contactToTime", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaContactToTime { get; set; } = default!;
        ...
        /// Lineage reference object : SPRCMNT_CMTT_CODE, Lookup lineage reference object : stvcmtt
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.cmttCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaCmttCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SPRCMNT_TEXT
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.text", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaText { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SPRCMNT_CONTACT_DATE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.contactDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? CriteriaContactDate { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.contactFromTime", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaContactFromTime { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.confidentialInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaConfidentialInd { get; set; } = default!;
