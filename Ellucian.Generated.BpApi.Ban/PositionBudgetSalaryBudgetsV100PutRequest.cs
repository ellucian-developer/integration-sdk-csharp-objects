...
namespace Ellucian.Generated.BpApi.Ban.PositionBudgetSalaryBudgetsV100PutRequest
{
    ...
    public partial class PositionBudgetSalaryBudgetsV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : NBRPTOT_BASE_UNITS
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.baseUnits", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaBaseUnits { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : NBRPTOT_BUDG_BASIS
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.budgBasis", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaBudgBasis { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : NBRPTOT_FTE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.fte", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.annBasis", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaAnnBasis { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : NBRPTOT_BUDGET
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.budget", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaBudget { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : NBRPTOT_OBUD_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.obudCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaObudCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.sgrpCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.fiscCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaFiscCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : NBRPTOT_OBPH_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.obphCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaObphCode { get; set; } = default!;
