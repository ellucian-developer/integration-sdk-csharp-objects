...
namespace Ellucian.Generated.BpApi.Ban.RulesMaintenanceV100QapiPost
{
    ...
    public partial class RulesMaintenanceV100QapiPost
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("classTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ClassTitle { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVRUCL_BALANCE_METHOD
        /// </summary>
        [Newtonsoft.Json.JsonProperty("balanceMethod", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
