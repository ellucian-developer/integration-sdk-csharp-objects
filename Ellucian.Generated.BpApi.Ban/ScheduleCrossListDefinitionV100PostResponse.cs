...
namespace Ellucian.Generated.BpApi.Ban.ScheduleCrossListDefinitionV100PostResponse
{
    ...
    public partial class ScheduleCrossListDefinitionV100PostResponse
    {
    ...
    public partial class Ssrxlst
    {
        ...
        [Newtonsoft.Json.JsonProperty("orTo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OrTo { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("ssbsectSeatsAvail", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public object SsbsectSeatsAvail { get; set; } = default!;

        /// <summary>
        /// Lookup lineage reference object : stvcamp
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ssbsectCampCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SsbsectCampCode { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("ssbsectEnrl", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("ssbsectWaitCount", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public object SsbsectWaitCount { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("scbcrseCreditHrs", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? ScbcrseCreditHrs { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("ssbsectWaitAvail", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public object SsbsectWaitAvail { get; set; } = default!;
