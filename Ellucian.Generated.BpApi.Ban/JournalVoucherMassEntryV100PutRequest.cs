...
namespace Ellucian.Generated.BpApi.Ban.JournalVoucherMassEntryV100PutRequest
{
    ...
    public partial class JournalVoucherMassEntryV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.fgbjvchTransDate", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset CriteriaFgbjvchTransDate { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FGBJVCD_PRJD_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.prjdCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaPrjdCode { get; set; } = default!;
        ...
        /// Lineage reference object : FGBJVCH_DOC_AMT
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.docAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaDocAmt { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.emcUnits", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaEmcUnits { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.giftDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? CriteriaGiftDate { get; set; } = default!;
        ...
        /// Lineage reference object : FGBJVCD_BUDGET_PERIOD
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.budgetPeriod", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaBudgetPeriod { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.ruclCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaRuclCode { get; set; } = default!;
