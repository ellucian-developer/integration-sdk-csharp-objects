...
namespace Ellucian.Generated.BpApi.Ban.JournalVoucherEntryV100QapiPost
{
    ...
    public partial class JournalVoucherEntryV100QapiPost
    {
        ...
        public string? SubmissionNumber { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("distribAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DistribAmt { get; set; } = default!;
