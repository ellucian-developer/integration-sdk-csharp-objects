...
namespace Ellucian.Generated.BpApi.Ban.AccountCommentTypeCodesV100PutRequest
{
    ...
    public partial class AccountCommentTypeCodesV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.termReqInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaTermReqInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("enddateReqInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EnddateReqInd { get; set; } = default!;
        ...
        /// Lineage reference object : TTVCMNT_ENDDATE_REQ_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.enddateReqInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaEnddateReqInd { get; set; } = default!;
