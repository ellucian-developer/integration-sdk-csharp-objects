...
namespace Ellucian.Generated.BpApi.Ban.GeneralTextEntryV100PutRequest
{
    ...
    public partial class GeneralTextEntryV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prtInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PrtInd { get; set; } = default!;
        ...
        /// Lineage reference object : FOBTEXT_PRT_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.prtInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaPrtInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FOBTEXT_SEQ_NUM
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.seqNum", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
