...
namespace Ellucian.Generated.BpApi.Ban.CourseDetailInformationTransferInstitutionsV100GetResponse
{
    ...
    public partial class CourseDetailInformationTransferInstitutionsV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("sbgi_ctrl_block", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Sbgi_ctrl_block>? Sbgi_ctrl_block { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("scrsbgi", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Scrsbgi>? Scrsbgi { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Sbgi_ctrl_block
    {
        /// <summary>
        /// Lineage reference object : scrsbgiTermCodeTo
        /// </summary>
        [Newtonsoft.Json.JsonProperty("scrsbgiTermCodeTo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ScrsbgiTermCodeTo { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : scrsbgiTermCodeFrom
        /// </summary>
        [Newtonsoft.Json.JsonProperty("scrsbgiTermCodeFrom", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ScrsbgiTermCodeFrom { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Scrsbgi
    {
        [Newtonsoft.Json.JsonProperty("sbgiDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SbgiDescription { get; set; } = default!;
