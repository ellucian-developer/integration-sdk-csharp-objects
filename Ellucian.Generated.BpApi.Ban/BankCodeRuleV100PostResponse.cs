...
namespace Ellucian.Generated.BpApi.Ban.BankCodeRuleV100PostResponse
{
    ...
    public partial class BankCodeRuleV100PostResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("bankFundTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? BankFundTitle { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("displayDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("cashAcctTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CashAcctTitle { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("interfundAcctTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? InterfundAcctTitle { get; set; } = default!;
