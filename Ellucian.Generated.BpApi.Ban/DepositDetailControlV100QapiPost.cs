...
namespace Ellucian.Generated.BpApi.Ban.DepositDetailControlV100QapiPost
{
    ...
    public partial class DepositDetailControlV100QapiPost
    {
        /// <summary>
        /// Lineage reference object : TBBDEPC_DETAIL_CODE_DEPOSIT, Lookup lineage reference object : tbbdetc
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detailCodeDeposit", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DetailCodeDeposit { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("detcDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DetcDescription { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : TBBDEPC_DETAIL_CODE_PAYMENT, Lookup lineage reference object : tbbdetc
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detailCodePayment", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DetailCodePayment { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : TBBDEPC_AUTO_RELEASE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("autoReleaseInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
