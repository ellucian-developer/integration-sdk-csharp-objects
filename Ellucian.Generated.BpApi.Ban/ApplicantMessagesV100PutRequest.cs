...
namespace Ellucian.Generated.BpApi.Ban.ApplicantMessagesV100PutRequest
{
    ...
    public partial class ApplicantMessagesV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.fullDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaFullDesc { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : RORMESG_MESG_CODE, Lookup lineage reference object : rtvmesg
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.mesgCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaMesgCode { get; set; } = default!;
