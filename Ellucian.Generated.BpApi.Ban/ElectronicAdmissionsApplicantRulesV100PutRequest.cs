...
namespace Ellucian.Generated.BpApi.Ban.ElectronicAdmissionsApplicantRulesV100PutRequest
{
    ...
    public partial class ElectronicAdmissionsApplicantRulesV100PutRequest
    {
        /// <summary>
        ...
        /// Lineage reference object : SARERUL_SYSTEM_REQ_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.systemReqInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSystemReqInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SARERUL_FUNCTION
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.function", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaFunction { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.value", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaValue { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SARERUL_EDI_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.ediInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaEdiInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SARERUL_EGRP_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.egrpCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaEgrpCode { get; set; } = default!;
