...
namespace Ellucian.Generated.BpApi.Ban.RulesMaintenanceV100PutRequest
{
    ...
    public partial class RulesMaintenanceV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.classTitle", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaClassTitle { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.classType", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaClassType { get; set; } = default!;
        ...
        /// Lineage reference object : FTVRUCL_CLASS_TITLE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("classTitle", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// Lineage reference object : FTVRUCL_CLASS_TYPE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("classType", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ClassType { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVRUCL_BALANCE_METHOD
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.balanceMethod", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaBalanceMethod { get; set; } = default!;
