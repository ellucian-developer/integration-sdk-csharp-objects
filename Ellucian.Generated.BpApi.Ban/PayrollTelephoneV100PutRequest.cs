...
namespace Ellucian.Generated.BpApi.Ban.PayrollTelephoneV100PutRequest
{
    ...
    public partial class PayrollTelephoneV100PutRequest
    {
        [Newtonsoft.Json.JsonProperty("criteria.teleDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaTeleDescription { get; set; } = default!;
