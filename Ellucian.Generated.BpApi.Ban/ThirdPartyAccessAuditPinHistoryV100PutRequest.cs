...
namespace Ellucian.Generated.BpApi.Ban.ThirdPartyAccessAuditPinHistoryV100PutRequest
{
    ...
    public partial class ThirdPartyAccessAuditPinHistoryV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : GOBTPAC_EXTERNAL_USER
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.externalUser", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaExternalUser { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.ldapUser", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaLdapUser { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.pinDisabledInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaPinDisabledInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GOBTPAC_INSERT_SOURCE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.insertSource", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaInsertSource { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GOBTPAC_PIN_EXP_DATE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.pinExpDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? CriteriaPinExpDate { get; set; } = default!;
        ...
        /// Lineage reference object : GOBTPAC_USAGE_ACCEPT_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.usageAcceptInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaUsageAcceptInd { get; set; } = default!;
