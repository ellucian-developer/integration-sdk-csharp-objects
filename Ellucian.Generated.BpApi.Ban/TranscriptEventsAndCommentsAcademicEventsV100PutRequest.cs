...
namespace Ellucian.Generated.BpApi.Ban.TranscriptEventsAndCommentsAcademicEventsV100PutRequest
{
    ...
    public partial class TranscriptEventsAndCommentsAcademicEventsV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : keyblckOrigCode, Lookup lineage reference object : stvorig
        /// </summary>
        [Newtonsoft.Json.JsonProperty("keyblckOrigCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? KeyblckOrigCode { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("criteria.descNondb", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaDescNondb { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.evenCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("keyblckLevlCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? KeyblckLevlCode { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("descNondb", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DescNondb { get; set; } = default!;
        ...
        /// Lineage reference object : SHREVNT_EVEN_CODE, Lookup lineage reference object : stveven
        /// </summary>
        [Newtonsoft.Json.JsonProperty("evenCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// Lineage reference object : SHREVNT_DECISION
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.decision", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaDecision { get; set; } = default!;
