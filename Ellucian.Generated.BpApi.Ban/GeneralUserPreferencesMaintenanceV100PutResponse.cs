...
namespace Ellucian.Generated.BpApi.Ban.GeneralUserPreferencesMaintenanceV100PutResponse
{
    ...
    public partial class GeneralUserPreferencesMaintenanceV100PutResponse
    {
        [Newtonsoft.Json.JsonProperty("display_options", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Display_options>? Display_options { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("guruprf_ui", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Guruprf_ui>? Guruprf_ui { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Display_options
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("formnameCb", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FormnameCb { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Guruprf_ui
    {
        [Newtonsoft.Json.JsonProperty("defltValue", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DefltValue { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GURUPRF_VALUE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("guruprfValue", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? GuruprfValue { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("defltKey", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DefltKey { get; set; } = default!;
