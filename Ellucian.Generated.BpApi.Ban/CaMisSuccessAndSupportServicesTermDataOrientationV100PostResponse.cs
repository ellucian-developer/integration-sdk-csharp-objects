...
namespace Ellucian.Generated.BpApi.Ban.CaMisSuccessAndSupportServicesTermDataOrientationV100PostResponse
{
    ...
    public partial class CaMisSuccessAndSupportServicesTermDataOrientationV100PostResponse
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("svvosstNoncreditServiceInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SvvosstNoncreditServiceInd { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("osstDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OsstDesc { get; set; } = default!;
