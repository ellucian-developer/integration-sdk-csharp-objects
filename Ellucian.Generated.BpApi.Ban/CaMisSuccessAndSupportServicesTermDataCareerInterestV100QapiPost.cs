...
namespace Ellucian.Generated.BpApi.Ban.CaMisSuccessAndSupportServicesTermDataCareerInterestV100QapiPost
{
    ...
    public partial class CaMisSuccessAndSupportServicesTermDataCareerInterestV100QapiPost
    {
        ...
        public string? SvamstdTermCode { get; set; } = default!;
        ...
        public string? SvamstdDicdCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SVRCRIN_CINT_CODE, Lookup lineage reference object : svvcint
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cintCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
