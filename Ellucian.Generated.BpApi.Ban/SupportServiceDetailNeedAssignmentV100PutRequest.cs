...
namespace Ellucian.Generated.BpApi.Ban.SupportServiceDetailNeedAssignmentV100PutRequest
{
    ...
    public partial class SupportServiceDetailNeedAssignmentV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : SERDTND_NDRF_CODE, Lookup lineage reference object : stvndrf
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ndrfCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? NdrfCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SERDTND_NDRF_CODE, Lookup lineage reference object : stvndrf
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.ndrfCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaNdrfCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SERDTND_NEED_CODE, Lookup lineage reference object : stvneed
        /// </summary>
        [Newtonsoft.Json.JsonProperty("needCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// Lineage reference object : SERDTND_SELF_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.selfInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSelfInd { get; set; } = default!;
        ...
        /// Lineage reference object : SERDTND_NEED_CODE, Lookup lineage reference object : stvneed
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.needCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaNeedCode { get; set; } = default!;
