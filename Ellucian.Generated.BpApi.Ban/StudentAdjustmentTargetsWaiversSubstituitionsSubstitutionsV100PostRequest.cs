...
namespace Ellucian.Generated.BpApi.Ban.StudentAdjustmentTargetsWaiversSubstituitionsSubstitutionsV100PostRequest
{
    ...
    public partial class StudentAdjustmentTargetsWaiversSubstituitionsSubstitutionsV100PostRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("smrssubSubjCodeReq", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SmrssubSubjCodeReq { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("smrssubSubjCodeSub", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SmrssubSubjCodeSub { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("smrssubActnCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SmrssubActnCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("smrssubAttrCodeReq", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SmrssubAttrCodeReq { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SMRSSUB_CRSE_NUMB_REQ
        /// </summary>
        [Newtonsoft.Json.JsonProperty("smrssubCrseNumbReq", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SmrssubCrseNumbReq { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("smrssubCrseNumbSub", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SmrssubCrseNumbSub { get; set; } = default!;
