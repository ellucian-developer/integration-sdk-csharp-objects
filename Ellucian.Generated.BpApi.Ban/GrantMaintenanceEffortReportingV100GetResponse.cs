...
namespace Ellucian.Generated.BpApi.Ban.GrantMaintenanceEffortReportingV100GetResponse
{
    ...
    public partial class GrantMaintenanceEffortReportingV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("frrgrec", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Frrgrec>? Frrgrec { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Frrgrec
    {
        /// <summary>
        /// Lineage reference object : FRRGREC_ACCT_ELEMENT
        /// </summary>
        [Newtonsoft.Json.JsonProperty("acctElement", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string AcctElement { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("acctElementValue", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AcctElementValue { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FRRGREC_ECCG_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("eccgCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EccgCode { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("acctElementValueDes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AcctElementValueDes { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FRRGREC_REPORT_SECTION
        /// </summary>
        [Newtonsoft.Json.JsonProperty("reportSection", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ReportSection { get; set; } = default!;
