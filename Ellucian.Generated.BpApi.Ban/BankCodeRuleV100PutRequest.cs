...
namespace Ellucian.Generated.BpApi.Ban.BankCodeRuleV100PutRequest
{
    ...
    public partial class BankCodeRuleV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : GXVBANK_COMPANY_ID
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.companyId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCompanyId { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.achOrigNo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAchOrigNo { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GXVBANK_COMPANY_TYPE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.companyType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCompanyType { get; set; } = default!;
        ...
        /// Lineage reference object : GXVBANK_ACCT_CODE_INTERFUND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctCodeInterfund", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAcctCodeInterfund { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.achStatus", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAchStatus { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("criteria.displayNchgDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? CriteriaDisplayNchgDate { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.bankRoutNum", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaBankRoutNum { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GXVBANK_ACCT_NAME
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctName", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaAcctName { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GXVBANK_ACCT_NUM
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctNum", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaAcctNum { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctCodeCash", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAcctCodeCash { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GXVBANK_ACH_DEST_NO
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.achDestNo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAchDestNo { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.achOrigName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAchOrigName { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.achDestName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAchDestName { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.achShortOrigName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAchShortOrigName { get; set; } = default!;
