...
namespace Ellucian.Generated.BpApi.Ban.GradableComponentDefinitionSubcomponentV100GetRequest
{
    ...
    public partial class GradableComponentDefinitionSubcomponentV100GetRequest
    {
        /// <summary>
        ...
        public double? ShrscomSeqNo { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shrscomName", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public double? ShrscomMinPassScore { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shrscomWeight", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double ShrscomWeight { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SHRSCOM_DESCRIPTION
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shrscomDescription", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ShrscomDescription { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SHRSCOM_TOTAL_SCORE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shrscomTotalScore", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double ShrscomTotalScore { get; set; } = default!;
