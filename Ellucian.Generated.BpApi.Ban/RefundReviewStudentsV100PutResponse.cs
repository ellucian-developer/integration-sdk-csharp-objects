...
namespace Ellucian.Generated.BpApi.Ban.RefundReviewStudentsV100PutResponse
{
    ...
    public partial class RefundReviewStudentsV100PutResponse
    {
        /// <summary>
        /// Lineage reference object : T4_REFUND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("t4Refund", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? T4Refund { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : ALL_REFUND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("allRefund", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? AllRefund { get; set; } = default!;
        ...
        public double? Pending { get; set; } = default!;
