...
namespace Ellucian.Generated.BpApi.Ban.StudentCohortV100PostRequest
{
    ...
    public partial class StudentCohortV100PostRequest
    {
        /// <summary>
        ...
        /// Lineage reference object : SGRCHRT_ACTIVE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sgrchrtActiveInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SgrchrtActiveInd { get; set; } = default!;
