...
namespace Ellucian.Generated.BpApi.Ban.AwardMaintenanceV100PutRequest
{
    ...
    public partial class AwardMaintenanceV100PutRequest
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("criteria.displayDeccanAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaDisplayDeccanAmt { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("criteria.displayMemautAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaDisplayMemautAmt { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : RPRAWRD_UNMET_NEED_OVRDE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.unmetNeedOvrdeInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaUnmetNeedOvrdeInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : RPRAWRD_FED_LIMIT_OVRDE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.fedLimitOvrdeInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaFedLimitOvrdeInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.replaceTfcOvrdeInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaReplaceTfcOvrdeInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.paidAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaPaidAmt { get; set; } = default!;
        ...
        /// Lineage reference object : RPRAWRD_TREQ_OVRDE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.treqOvrdeInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaTreqOvrdeInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : RPRAWRD_FUND_LIMIT_OVRDE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.fundLimitOvrdeInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaFundLimitOvrdeInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : RPRAWRD_OVERRIDE_FUND_RULE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.overrideFundRule", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaOverrideFundRule { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.awstCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAwstCode { get; set; } = default!;
        ...
        /// Lineage reference object : RPRAWRD_LOCK_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.lockInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaLockInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.offerAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaOfferAmt { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : RPRAWRD_ACCEPT_AMT
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acceptAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaAcceptAmt { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("criteria.displayRescheduleInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaDisplayRescheduleInd { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("criteria.fundDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaFundDescription { get; set; } = default!;
