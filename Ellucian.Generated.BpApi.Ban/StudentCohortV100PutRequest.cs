...
namespace Ellucian.Generated.BpApi.Ban.StudentCohortV100PutRequest
{
    ...
    public partial class StudentCohortV100PutRequest
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("criteria.bannerId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaBannerId { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("criteria.termCodeTo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaTermCodeTo { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SGRCHRT_CREA_CODE, Lookup lineage reference object : stvcrea
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.creaCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCreaCode { get; set; } = default!;
        ...
        public string? CriteriaStspKeySequence { get; set; } = default!;
