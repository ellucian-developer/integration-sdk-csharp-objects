...
namespace Ellucian.Generated.BpApi.Ban.CourseDetailInformationFeeCodesV100GetResponse
{
    ...
    public partial class CourseDetailInformationFeeCodesV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("fee_ctrl_block", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Fee_ctrl_block>? Fee_ctrl_block { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("scrfees", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Scrfees>? Scrfees { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Fee_ctrl_block
    {
        /// <summary>
        /// Lineage reference object : scrfeesTermCodeTo
        /// </summary>
        [Newtonsoft.Json.JsonProperty("scrfeesTermCodeTo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ScrfeesTermCodeTo { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : scrfeesTermCodeFrom
        /// </summary>
        [Newtonsoft.Json.JsonProperty("scrfeesTermCodeFrom", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ScrfeesTermCodeFrom { get; set; } = default!;
