...
namespace Ellucian.Generated.BpApi.Ban.TestCodesV100GetResponse
{
    ...
    public partial class TestCodesV100GetResponse
    {
        /// <summary>
        /// Lineage reference object : STVTESC_ASSESSMENT_FORM
        /// </summary>
        [Newtonsoft.Json.JsonProperty("assessmentForm", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AssessmentForm { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("noPositions", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double NoPositions { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("misCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? MisCode { get; set; } = default!;
