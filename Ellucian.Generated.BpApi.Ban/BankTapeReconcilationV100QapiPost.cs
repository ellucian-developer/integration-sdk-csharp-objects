...
namespace Ellucian.Generated.BpApi.Ban.BankTapeReconcilationV100QapiPost
{
    ...
    public partial class BankTapeReconcilationV100QapiPost
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("checkDepositCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CheckDepositCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FABBKTP_CHECK_DEPOSIT_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("checkDepositInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
