...
namespace Ellucian.Generated.BpApi.Ban.CurriculumRulesBaseCurriculumRulesV100PutRequest
{
    ...
    public partial class CurriculumRulesBaseCurriculumRulesV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.primRollInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaPrimRollInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.lockInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaLockInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SOBCURR_TERM_CODE_INIT, Lookup lineage reference object : stvterm
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.termCodeInit", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaTermCodeInit { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SOBCURR_STUDY_PATH_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.studyPathInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaStudyPathInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.currRule", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaCurrRule { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SOBCURR_SECD_ROLL_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.secdRollInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSecdRollInd { get; set; } = default!;
