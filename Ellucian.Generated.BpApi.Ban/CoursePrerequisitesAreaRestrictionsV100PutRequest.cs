...
namespace Ellucian.Generated.BpApi.Ban.CoursePrerequisitesAreaRestrictionsV100PutRequest
{
    ...
    public partial class CoursePrerequisitesAreaRestrictionsV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("scrrareArea", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ScrrareArea { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("criteria.areaDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAreaDesc { get; set; } = default!;
