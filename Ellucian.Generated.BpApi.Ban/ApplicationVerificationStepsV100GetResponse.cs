...
namespace Ellucian.Generated.BpApi.Ban.ApplicationVerificationStepsV100GetResponse
{
    ...
    public partial class ApplicationVerificationStepsV100GetResponse
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("applInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ApplInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("persInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PersInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : STVASTA_LOAD_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("loadInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? LoadInd { get; set; } = default!;
