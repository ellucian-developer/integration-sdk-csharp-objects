...
namespace Ellucian.Generated.BpApi.Ban.JournalVoucherMassEntryV100QapiPost
{
    ...
    public partial class JournalVoucherMassEntryV100QapiPost
    {
        ...
        [Newtonsoft.Json.JsonProperty("docAmt", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string DocAmt { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("nsfOnOffInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string NsfOnOffInd { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("editDeferInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
