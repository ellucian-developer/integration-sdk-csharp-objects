...
namespace Ellucian.Generated.BpApi.Ban.EmployeeJobsExcludedDeductionsBenefitsV100PutRequest
{
    ...
    public partial class EmployeeJobsExcludedDeductionsBenefitsV100PutRequest
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("criteria.bdcaDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaBdcaDesc { get; set; } = default!;
