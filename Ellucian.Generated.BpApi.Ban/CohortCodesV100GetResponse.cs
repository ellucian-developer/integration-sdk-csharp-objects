...
namespace Ellucian.Generated.BpApi.Ban.CohortCodesV100GetResponse
{
    ...
    public partial class CohortCodesV100GetResponse
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("termCodeStart", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TermCodeStart { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : STVCHRT_RIGHT_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("rightInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? RightInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : STVCHRT_TERM_CODE_100PRCNT, Lookup lineage reference object : stvterm
        /// </summary>
        [Newtonsoft.Json.JsonProperty("termCode100Prcnt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TermCode100Prcnt { get; set; } = default!;
