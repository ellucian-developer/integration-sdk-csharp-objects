...
namespace Ellucian.Generated.BpApi.Ban.AccountCodeMaintenanceV100PostResponse
{
    ...
    public partial class AccountCodeMaintenanceV100PostResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("accountClassTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AccountClassTitle { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("incomeDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? IncomeDescription { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("deprExpTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DeprExpTitle { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("fringeAccountTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FringeAccountTitle { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("accountTypeTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AccountTypeTitle { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("normalBalanceDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? NormalBalanceDescription { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("accumDeprTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AccumDeprTitle { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("assetAccountTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AssetAccountTitle { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("poolAccountTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PoolAccountTitle { get; set; } = default!;
