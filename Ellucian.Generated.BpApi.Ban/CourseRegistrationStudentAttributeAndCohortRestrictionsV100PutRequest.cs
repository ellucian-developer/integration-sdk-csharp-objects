...
namespace Ellucian.Generated.BpApi.Ban.CourseRegistrationStudentAttributeAndCohortRestrictionsV100PutRequest
{
    ...
    public partial class CourseRegistrationStudentAttributeAndCohortRestrictionsV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : SCRRATT_ATTS_CODE, Lookup lineage reference object : stvatts
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.criteriaAttsCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCriteriaAttsCode { get; set; } = default!;
        ...
        /// Lineage reference object : SCRRCHR_CHRT_CODE, Lookup lineage reference object : stvchrt
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.criteriaChrtCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCriteriaChrtCode { get; set; } = default!;
