...
namespace Ellucian.Generated.BpApi.Ban.CourseDetailInformationCorequisitesAndEquivalentsV100PutRequest
{
    ...
    public partial class CourseDetailInformationCorequisitesAndEquivalentsV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : SCREQIV_SUBJ_CODE_EQIV, Lookup lineage reference object : scbcrse,scbcrky
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.subjCodeEqiv", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaSubjCodeEqiv { get; set; } = default!;
        ...
        /// Lineage reference object : SCRCORQ_SUBJ_CODE_CORQ, Lookup lineage reference object : scbcrse,scbcrky
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.subjCodeCorq", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaSubjCodeCorq { get; set; } = default!;
