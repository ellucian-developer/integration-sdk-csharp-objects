...
namespace Ellucian.Generated.BpApi.Ban.TermCourseMaintenanceStoredGpaByTermCalculationV010GetRequest
{
    ...
    public partial class TermCourseMaintenanceStoredGpaByTermCalculationV010GetRequest
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("displayQualityPoints", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? DisplayQualityPoints { get; set; } = default!;
