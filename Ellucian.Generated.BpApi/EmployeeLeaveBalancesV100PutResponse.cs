...
namespace Ellucian.Generated.BpApi.Ban.EmployeeLeaveBalancesV100PutResponse
{
    ...
    public partial class EmployeeLeaveBalancesV100PutResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("leavDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? LeavDesc { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("hourInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? HourInd { get; set; } = default!;
