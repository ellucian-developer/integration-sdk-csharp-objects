...
namespace Ellucian.Generated.BpApi.Ban.ThirdPartyAccessAuditVerifyAnswersV100GetResponse
{
    ...
    public partial class ThirdPartyAccessAuditVerifyAnswersV100GetResponse
    {
        ...
        public System.Collections.Generic.ICollection<Dummy>? Dummy { get; set; } = default!;
    ...
    public partial class Dummy
    {
        ...
        [Newtonsoft.Json.JsonProperty("gobansrActivityDate1", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? GobansrActivityDate1 { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("questionValue", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? QuestionValue { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("verifyAnswer", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? VerifyAnswer { get; set; } = default!;
