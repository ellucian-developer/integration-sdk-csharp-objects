...
namespace Ellucian.Generated.BpApi.Ban.VisaTypeCodesV100GetResponse
{
    ...
    public partial class VisaTypeCodesV100GetResponse
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("nonResInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? NonResInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : STVVTYP_STATSCAN_CDE2
        /// </summary>
        [Newtonsoft.Json.JsonProperty("statscanCde2", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? StatscanCde2 { get; set; } = default!;
