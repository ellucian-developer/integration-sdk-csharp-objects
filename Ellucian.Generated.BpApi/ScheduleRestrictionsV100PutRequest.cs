...
namespace Ellucian.Generated.BpApi.Ban.ScheduleRestrictionsV100PutRequest
{
    ...
    public partial class ScheduleRestrictionsV100PutRequest
    {
        [Newtonsoft.Json.JsonProperty("criteria.termDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaTermDescription { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.rtrmCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaRtrmCode { get; set; } = default!;
