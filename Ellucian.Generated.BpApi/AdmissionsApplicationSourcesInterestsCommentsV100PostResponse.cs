...
namespace Ellucian.Generated.BpApi.Ban.AdmissionsApplicationSourcesInterestsCommentsV100PostResponse
{
    ...
    public partial class AdmissionsApplicationSourcesInterestsCommentsV100PostResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("saracmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Saracmt>? Saracmt { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("sarrsrc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Sarrsrc>? Sarrsrc { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("sorints", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Sorints>? Sorints { get; set; } = default!;
    ...
    public partial class Sorints
    {
        ...
        [Newtonsoft.Json.JsonProperty("intsDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? IntsDesc { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SORINTS_INTS_CODE, Lookup lineage reference object : stvints
        /// </summary>
        [Newtonsoft.Json.JsonProperty("intsCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string IntsCode { get; set; } = default!;
