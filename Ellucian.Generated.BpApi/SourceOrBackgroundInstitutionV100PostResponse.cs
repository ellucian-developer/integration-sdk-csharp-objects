...
namespace Ellucian.Generated.BpApi.Ban.SourceOrBackgroundInstitutionV100PostResponse
{
    ...
    public partial class SourceOrBackgroundInstitutionV100PostResponse
    {
        [Newtonsoft.Json.JsonProperty("sorbcmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Sorbcmt>? Sorbcmt { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("sorbcnt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Sorbcnt>? Sorbcnt { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("sobsbgi", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Sobsbgi>? Sobsbgi { get; set; } = default!;
    ...
    public partial class Sorbcnt
    {
        ...
        [Newtonsoft.Json.JsonProperty("ptypDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PtypDescription { get; set; } = default!;
