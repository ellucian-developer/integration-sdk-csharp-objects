...
namespace Ellucian.Generated.BpApi.Ban.GrantMaintenancePersonnelV100GetResponse
{
    ...
    public partial class GrantMaintenancePersonnelV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("frrgrpi", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Frrgrpi>? Frrgrpi { get; set; } = default!;
    ...
    public partial class Frrgrpi
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("teleSeqno", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? TeleSeqno { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("idIndName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? IdIndName { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FRRGRPI_EMPLOYEE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("employeeInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EmployeeInd { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("orgnCodeName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OrgnCodeName { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("idInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? IdInd { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("idName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? IdName { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("bfrmName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? BfrmName { get; set; } = default!;
