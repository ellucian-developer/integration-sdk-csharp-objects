...
namespace Ellucian.Generated.BpApi.Ban.VendorMaintenanceV100PostResponse
{
    ...
    public partial class VendorMaintenanceV100PostResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("ftmvendDiscDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FtmvendDiscDesc { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("textExistInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TextExistInd { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("pmtHoldCodeDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PmtHoldCodeDesc { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("ftmvendFormStatusDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FtmvendFormStatusDesc { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("poHoldCodeDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PoHoldCodeDesc { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("ftmvendItypDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FtmvendItypDesc { get; set; } = default!;
