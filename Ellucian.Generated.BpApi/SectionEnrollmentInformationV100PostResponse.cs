...
namespace Ellucian.Generated.BpApi.Ban.SectionEnrollmentInformationV100PostResponse
{
    ...
    public partial class SectionEnrollmentInformationV100PostResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("ssrresv", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Ssrresv>? Ssrresv { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Ssrresv
    {
        [Newtonsoft.Json.JsonProperty("holdSsrresvEnrl", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? HoldSsrresvEnrl { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("holdSsrresvWaitCapacity", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double HoldSsrresvWaitCapacity { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("holdSsrresvSeatsAvail", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? HoldSsrresvSeatsAvail { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("holdSsrresvWaitCount", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? HoldSsrresvWaitCount { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("holdSsrresvWaitAvail", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? HoldSsrresvWaitAvail { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("holdSsrresvMaxEnrl", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double HoldSsrresvMaxEnrl { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("overflowInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OverflowInd { get; set; } = default!;
