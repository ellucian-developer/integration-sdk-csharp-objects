...
namespace Ellucian.Generated.BpApi.Ban.CaMisSuccessAndSupportServicesTermDataCareerInterestV100PutRequest
{
    ...
    public partial class CaMisSuccessAndSupportServicesTermDataCareerInterestV100PutRequest
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("svrcrinId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SvrcrinId { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.cintCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaCintCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SVRCRIN_CINT_CODE, Lookup lineage reference object : svvcint
        /// </summary>
        [Newtonsoft.Json.JsonProperty("svrcrinCintCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SvrcrinCintCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.svvcintNoncreditServiceInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSvvcintNoncreditServiceInd { get; set; } = default!;
