...
namespace Ellucian.Generated.BpApi.Ban.SystemControlFiscalYearsV100GetResponse
{
    ...
    public partial class SystemControlFiscalYearsV100GetResponse
    {
        [Newtonsoft.Json.JsonProperty("earliestOpenPeriod", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EarliestOpenPeriod { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("currentPeriodStartDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? CurrentPeriodStartDate { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("eoyAccrStatusInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("currentPeriodEndDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? CurrentPeriodEndDate { get; set; } = default!;
