...
namespace Ellucian.Generated.BpApi.Ban.DegreeSummaryV100GetResponse
{
    ...
    public partial class DegreeSummaryV100GetResponse
    {
    ...
    public partial class Shrdgmr
    {
        ...
        [Newtonsoft.Json.JsonProperty("dualDegInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DualDegInd { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("diplomaName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DiplomaName { get; set; } = default!;
