...
namespace Ellucian.Generated.BpApi.Ban.UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRulesV100GetResponse
{
    ...
    public partial class UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRulesV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("rlrdmpo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Rlrdmpo>? Rlrdmpo { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("rlrdmps", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Rlrdmps>? Rlrdmps { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Rlrdmpo
    {
        [Newtonsoft.Json.JsonProperty("displayMpnTypeDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DisplayMpnTypeDesc { get; set; } = default!;
    ...
    public partial class Rlrdmps
    {
        ...
        [Newtonsoft.Json.JsonProperty("displayReqStatusDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DisplayReqStatusDesc { get; set; } = default!;
