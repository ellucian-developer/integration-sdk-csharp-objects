...
namespace Ellucian.Generated.BpApi.Ban.SectionSectionPreferencesV100GetResponse
{
    ...
    public partial class SectionSectionPreferencesV100GetResponse
    {
        [Newtonsoft.Json.JsonProperty("ssrsrdf", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Ssrsrdf>? Ssrsrdf { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("ssrsprt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Ssrsprt>? Ssrsprt { get; set; } = default!;
    ...
    public partial class Ssrsrdf
    {
        ...
        [Newtonsoft.Json.JsonProperty("srdfRdefDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SrdfRdefDesc { get; set; } = default!;
    ...
    public partial class Ssrsprt
    {
        ...
        [Newtonsoft.Json.JsonProperty("sprtParsDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SprtParsDesc { get; set; } = default!;
