...
namespace Ellucian.Generated.BpApi.Ban.StudentSportCompetitionV100PutRequest
{
    ...
    public partial class StudentSportCompetitionV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("beginTerm", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? BeginTerm { get; set; } = default!;
        ...
        public double? Season { get; set; } = default!;
