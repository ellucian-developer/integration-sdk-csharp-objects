...
namespace Ellucian.Generated.BpApi.Ban.CommentCentralV100PutRequest
{
    ...
    public partial class CommentCentralV100PutRequest
    {
        /// <summary>
        ...
        /// Lineage reference object : TBRCMNT_RESTRICT_UPDATE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.restrictUpdateInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaRestrictUpdateInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.term", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaTerm { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.commentCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCommentCode { get; set; } = default!;
        ...
        /// Lineage reference object : TBRCMNT_CREATED_BY, Lookup lineage reference object : stvorig
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.createdBy", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCreatedBy { get; set; } = default!;
        ...
        /// Lineage reference object : TBRCMNT_PURGE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.purgeInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaPurgeInd { get; set; } = default!;
