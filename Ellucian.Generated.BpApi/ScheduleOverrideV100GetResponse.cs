...
namespace Ellucian.Generated.BpApi.Ban.ScheduleOverrideV100GetResponse
{
    ...
    public partial class ScheduleOverrideV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("divsDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DivsDescription { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("topsDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TopsDescription { get; set; } = default!;
