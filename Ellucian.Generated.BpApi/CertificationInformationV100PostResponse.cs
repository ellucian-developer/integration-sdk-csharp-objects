...
namespace Ellucian.Generated.BpApi.Ban.CertificationInformationV100PostResponse
{
    ...
    public partial class CertificationInformationV100PostResponse
    {
        [Newtonsoft.Json.JsonProperty("pprends", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Pprends>? Pprends { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("pprcert", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Pprcert>? Pprcert { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Pprends
    {
        [Newtonsoft.Json.JsonProperty("endsDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EndsDesc { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Pprcert
    {
        [Newtonsoft.Json.JsonProperty("certDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CertDesc { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("lcsvCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public string CertCode { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("statDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? StatDesc { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : PPRCERT_CERT_DATE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("certDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("lcsvDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? LcsvDesc { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : PPRCERT_CERT_NO
        /// </summary>
        [Newtonsoft.Json.JsonProperty("certNo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
