...
namespace Ellucian.Generated.BpApi.Ban.PositionRequisitionV100PutResponse
{
    ...
    public partial class PositionRequisitionV100PutResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("apprName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ApprName { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("pclsTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PclsTitle { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("salaryRateLow", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? SalaryRateLow { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("salaryRateHigh", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? SalaryRateHigh { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("salaryRate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? SalaryRate { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("recrName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? RecrName { get; set; } = default!;
