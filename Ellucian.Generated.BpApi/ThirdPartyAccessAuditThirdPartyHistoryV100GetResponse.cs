...
namespace Ellucian.Generated.BpApi.Ban.ThirdPartyAccessAuditThirdPartyHistoryV100GetResponse
{
    ...
    public partial class ThirdPartyAccessAuditThirdPartyHistoryV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("gorpaud2", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Gorpaud2>? Gorpaud2 { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Gorpaud2
    {
        /// <summary>
        /// Lineage reference object : GORPAUD_EXTERNAL_USER
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gorpaudExternalUser", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? GorpaudExternalUser { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GORPAUD_USER
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gorpaudUser", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? GorpaudUser { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GORPAUD_ACTIVITY_DATE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gorpaudActivityDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? GorpaudActivityDate { get; set; } = default!;
