...
namespace Ellucian.Generated.BpApi.Ban.InstallmentPaymentPlanAmountV100GetResponse
{
    ...
    public partial class InstallmentPaymentPlanAmountV100GetResponse
    {
        [Newtonsoft.Json.JsonProperty("tbvinss", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Tbvinss>? Tbvinss { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("tbvinsp", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Tbvinsp>? Tbvinsp { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Tbvinsp
    {
        /// <summary>
        /// Lineage reference object : TBVINSP_CALC_EXISTING
        /// </summary>
        [Newtonsoft.Json.JsonProperty("calcExisting", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CalcExisting { get; set; } = default!;
