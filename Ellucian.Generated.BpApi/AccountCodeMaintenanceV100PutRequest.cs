...
namespace Ellucian.Generated.BpApi.Ban.AccountCodeMaintenanceV100PutRequest
{
    ...
    public partial class AccountCodeMaintenanceV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : FTVACCT_ACCT_CODE_FRINGE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctCodeFringe", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAcctCodeFringe { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dataEntryInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctCodePool", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAcctCodePool { get; set; } = default!;
        ...
        /// Lineage reference object : FTVACCT_DATA_ENTRY_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.dataEntryInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctCodePred", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAcctCodePred { get; set; } = default!;
        ...
        /// Lineage reference object : FTVACCT_FRINGE_PCT
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.fringePct", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaFringePct { get; set; } = default!;
        ...
        /// Lineage reference object : FTVACCT_ACCT_CODE_ASSET
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ftvacctAcctCodeAsset", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FtvacctAcctCodeAsset { get; set; } = default!;
        ...
        /// Lineage reference object : FTVACCT_ACCT_CLASS_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctClassCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAcctClassCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVACCT_ACCT_CODE_DEPR_EXP
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctCodeDeprExp", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAcctCodeDeprExp { get; set; } = default!;
        ...
        /// Lookup lineage reference object : ftvityp
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.incomeTypeCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaIncomeTypeCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVACCT_ACCT_CODE_ASSET
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctCodeAsset", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAcctCodeAsset { get; set; } = default!;
        ...
        /// Lineage reference object : FTVACCT_ACCT_CODE_DEPR_ACCUM
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.acctCodeDeprAccum", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAcctCodeDeprAccum { get; set; } = default!;
