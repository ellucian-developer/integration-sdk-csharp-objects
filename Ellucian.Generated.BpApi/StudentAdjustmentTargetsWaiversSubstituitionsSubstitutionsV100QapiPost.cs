...
namespace Ellucian.Generated.BpApi.Ban.StudentAdjustmentTargetsWaiversSubstituitionsSubstitutionsV100QapiPost
{
    ...
    public partial class StudentAdjustmentTargetsWaiversSubstituitionsSubstitutionsV100QapiPost
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("subjCodeReq", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SubjCodeReq { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SMRSSUB_CRSE_NUMB_REQ
        /// </summary>
        [Newtonsoft.Json.JsonProperty("crseNumbReq", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("subjCodeSub", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SubjCodeSub { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SMRSSUB_CRSE_NUMB_SUB
        /// </summary>
        [Newtonsoft.Json.JsonProperty("crseNumbSub", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
