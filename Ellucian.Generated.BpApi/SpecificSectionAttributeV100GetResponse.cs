...
namespace Ellucian.Generated.BpApi.Ban.SpecificSectionAttributeV100GetResponse
{
    ...
    public partial class SpecificSectionAttributeV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("selectManually", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SelectManually { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("selectAllInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SelectAllInd { get; set; } = default!;
