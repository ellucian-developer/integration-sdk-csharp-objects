...
namespace Ellucian.Generated.BpApi.Ban.ProxyAccessOptionTypesV100QapiPost
{
    ...
    public partial class ProxyAccessOptionTypesV100QapiPost
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("optionDefault", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OptionDefault { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GTVOTYP_SYSTEM_LEVEL_CDE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("systemLevelCde", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("systCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
