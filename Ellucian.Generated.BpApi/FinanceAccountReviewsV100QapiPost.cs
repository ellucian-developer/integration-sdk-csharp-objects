...
namespace Ellucian.Generated.BpApi.Ban.FinanceAccountReviewsV100QapiPost
{
    ...
    public partial class FinanceAccountReviewsV100QapiPost
    {
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? Id { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("colId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public string? PlanAmount { get; set; } = default!;
