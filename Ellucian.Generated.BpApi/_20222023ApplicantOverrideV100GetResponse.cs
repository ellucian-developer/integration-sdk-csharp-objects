...
namespace Ellucian.Generated.BpApi.Ban._20222023ApplicantOverrideV100GetResponse
{
    ...
    public partial class _20222023ApplicantOverrideV100GetResponse
    {
    ...
    public partial class Rorstat
    {
        ...
        [Newtonsoft.Json.JsonProperty("displayTransactionNumber", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? DisplayTransactionNumber { get; set; } = default!;
    ...
    public partial class Rnrovrd
    {
        ...
        /// <summary>
        /// Lineage reference object : RNROVRD_STU_COST_LIV_INDEX
        /// </summary>
        [Newtonsoft.Json.JsonProperty("stuCostLivIndex", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? StuCostLivIndex { get; set; } = default!;
        ...
        /// <summary>
        /// Lineage reference object : RNROVRD_ALLOW_PAR_INC_EXCL
        /// </summary>
        [Newtonsoft.Json.JsonProperty("allowParIncExcl", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AllowParIncExcl { get; set; } = default!;
        ...
        /// <summary>
        /// Lineage reference object : RNROVRD_ALLOW_INC_EXCL
        /// </summary>
        [Newtonsoft.Json.JsonProperty("allowIncExcl", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AllowIncExcl { get; set; } = default!;
