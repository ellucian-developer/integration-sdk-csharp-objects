...
namespace Ellucian.Generated.BpApi.Ban.ApprovalQueueMaintenanceV100PostResponse
{
    ...
    public partial class ApprovalQueueMaintenanceV100PostResponse
    {
        [Newtonsoft.Json.JsonProperty("ftvappq", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Ftvappq>? Ftvappq { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("foraqus", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Foraqus>? Foraqus { get; set; } = default!;
    ...
    public partial class Ftvappq
    {
        ...
        [Newtonsoft.Json.JsonProperty("nextQueueTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? NextQueueTitle { get; set; } = default!;
