...
namespace Ellucian.Generated.BpApi.Ban.RulesMaintenanceV100PostResponse
{
    ...
    public partial class RulesMaintenanceV100PostResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("balanceMethodDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? BalanceMethodDesc { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVRUCL_BALANCE_METHOD
        /// </summary>
        [Newtonsoft.Json.JsonProperty("balanceMethod", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string BalanceMethod { get; set; } = default!;
