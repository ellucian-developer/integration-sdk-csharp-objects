...
namespace Ellucian.Generated.BpApi.Ban.CrosswalkRulesV100GetResponse
{
    ...
    public partial class CrosswalkRulesV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("sysiDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SysiDesc { get; set; } = default!;
