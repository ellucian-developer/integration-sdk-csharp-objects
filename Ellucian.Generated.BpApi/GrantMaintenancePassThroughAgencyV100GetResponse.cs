...
namespace Ellucian.Generated.BpApi.Ban.GrantMaintenancePassThroughAgencyV100GetResponse
{
    ...
    public partial class GrantMaintenancePassThroughAgencyV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("frragpt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Frragpt>? Frragpt { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Frragpt
    {
        /// <summary>
        /// Lineage reference object : FRRAGPT_FEDERAL_FUND_PERCENT
        /// </summary>
        [Newtonsoft.Json.JsonProperty("federalFundPercent", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? FederalFundPercent { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("agcyName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AgcyName { get; set; } = default!;
