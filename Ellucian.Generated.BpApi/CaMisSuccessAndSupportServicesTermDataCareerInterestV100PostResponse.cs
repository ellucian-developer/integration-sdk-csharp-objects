...
namespace Ellucian.Generated.BpApi.Ban.CaMisSuccessAndSupportServicesTermDataCareerInterestV100PostResponse
{
    ...
    public partial class CaMisSuccessAndSupportServicesTermDataCareerInterestV100PostResponse
    {
        /// <summary>
        /// Lineage reference object : SVRCRIN_CINT_CODE, Lookup lineage reference object : svvcint
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cintCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CintCode { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("cintDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CintDesc { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("svvcintNoncreditServiceInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SvvcintNoncreditServiceInd { get; set; } = default!;
