...
namespace Ellucian.Generated.BpApi.Ban.FinancialManagersV100GetResponse
{
    ...
    public partial class FinancialManagersV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("finMgrName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FinMgrName { get; set; } = default!;
