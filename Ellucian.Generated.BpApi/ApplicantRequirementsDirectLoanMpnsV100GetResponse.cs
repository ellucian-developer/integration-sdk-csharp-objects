...
namespace Ellucian.Generated.BpApi.Ban.ApplicantRequirementsDirectLoanMpnsV100GetResponse
{
    ...
    public partial class ApplicantRequirementsDirectLoanMpnsV100GetResponse
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("loanNo", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double LoanNo { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("rlrdlorFundCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string RlrdlorFundCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("reqStatusDate", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset ReqStatusDate { get; set; } = default!;
