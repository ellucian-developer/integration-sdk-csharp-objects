...
namespace Ellucian.Generated.BpApi.Ban.TransactionsInProcessStatusV100GetResponse
{
    ...
    public partial class TransactionsInProcessStatusV100GetResponse
    {
        [Newtonsoft.Json.JsonProperty("fgrbako", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Fgrbako>? Fgrbako { get; set; } = default!;
    ...
    public partial class Fgrbako
    {
        ...
        public double? ItemNum { get; set; } = default!;
