...
namespace Ellucian.Generated.BpApi.Ban.CoursePrerequisitesV100GetResponse
{
    ...
    public partial class CoursePrerequisitesV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("scrrtst", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Scrrtst>? Scrrtst { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("scrrare", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Scrrare>? Scrrare { get; set; } = default!;
