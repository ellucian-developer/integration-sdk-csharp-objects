...
namespace Ellucian.Generated.BpApi.Ban.CaResidenceCodesV100GetResponse
{
    ...
    public partial class CaResidenceCodesV100GetResponse
    {
        /// <summary>
        /// Lineage reference object : STVRESD_IN_STATE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("inStateInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? InStateInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("bogwEligInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? BogwEligInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("foreignInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ForeignInd { get; set; } = default!;
