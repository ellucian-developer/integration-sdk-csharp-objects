...
namespace Ellucian.Generated.BpApi.Ban.PopulationSelectionInquiryV100GetResponse
{
    ...
    public partial class PopulationSelectionInquiryV100GetResponse
    {
        [Newtonsoft.Json.JsonProperty("glbslct", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Glbslct>? Glbslct { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("glvslct", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Glvslct>? Glvslct { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Glvslct
    {
        [Newtonsoft.Json.JsonProperty("glbextrUserId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? GlbextrUserId { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("glbextrCount", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? GlbextrCount { get; set; } = default!;
