...
namespace Ellucian.Generated.BpApi.Ban.CourseSearchV100GetResponse
{
    ...
    public partial class CourseSearchV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("scbcrse", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Scbcrse>? Scbcrse { get; set; } = default!;
    ...
    public partial class Scacrse_key_block
    {
        ...
        public object? SubjDescription { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("scacrseStartDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public object? ScacrseStartDate { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : scacrseEndDate
        /// </summary>
        [Newtonsoft.Json.JsonProperty("scacrseEndDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public object? ScacrseEndDate { get; set; } = default!;
    ...
    public partial class Scbcrse
    {
        ...
        [Newtonsoft.Json.JsonProperty("termTo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TermTo { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("effTerm", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EffTerm { get; set; } = default!;
