...
namespace Ellucian.Generated.BpApi.Ban.EmployeeLeaveBalancesV100GetRequest
{
    ...
    public partial class EmployeeLeaveBalancesV100GetRequest
    {
        [Newtonsoft.Json.JsonProperty("hrsBankedDay", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double HrsBankedDay { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("beginBalanceDay", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double BeginBalanceDay { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : PERLEAV_LEAV_CODE, Lookup lineage reference object : ptrlvas,ptrleav
        /// </summary>
        [Newtonsoft.Json.JsonProperty("leavCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string LeavCode { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("accruedDay", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double AccruedDay { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("totalBalanceDay", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double TotalBalanceDay { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("takenDay", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double TakenDay { get; set; } = default!;
