...
namespace Ellucian.Generated.BpApi.Ban.CourseSyllabusV100GetResponse
{
    ...
    public partial class CourseSyllabusV100GetResponse
    {
        [Newtonsoft.Json.JsonProperty("scrsylo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Scrsylo>? Scrsylo { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("scrsyln", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Scrsyln>? Scrsyln { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("scrsyrm", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Scrsyrm>? Scrsyrm { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("scrsytr", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Scrsytr>? Scrsytr { get; set; } = default!;
