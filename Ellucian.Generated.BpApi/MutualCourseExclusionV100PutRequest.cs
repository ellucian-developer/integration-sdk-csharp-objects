...
namespace Ellucian.Generated.BpApi.Ban.MutualCourseExclusionV100PutRequest
{
    ...
    public partial class MutualCourseExclusionV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : SCRMEXC_END_TERM, Lookup lineage reference object : stvterm
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.endTerm", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaEndTerm { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("crseNumbMexc", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CrseNumbMexc { get; set; } = default!;
        ...
        /// Lineage reference object : SCRMEXC_CRSE_NUMB_MEXC, Lookup lineage reference object : scbcrse,scbcrky
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.crseNumbMexc", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaCrseNumbMexc { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SCRMEXC_START_TERM, Lookup lineage reference object : stvterm
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.startTerm", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaStartTerm { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SCRMEXC_GRDE_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("grdeCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.subjCodeMexc", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaSubjCodeMexc { get; set; } = default!;
        ...
        /// Lineage reference object : SCRMEXC_GRDE_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.grdeCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaGrdeCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SCRMEXC_SUBJ_CODE_MEXC, Lookup lineage reference object : scbcrse,scbcrky
        /// </summary>
        [Newtonsoft.Json.JsonProperty("subjCodeMexc", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SubjCodeMexc { get; set; } = default!;
