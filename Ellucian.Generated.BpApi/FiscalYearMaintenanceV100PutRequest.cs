...
namespace Ellucian.Generated.BpApi.Ban.FiscalYearMaintenanceV100PutRequest
{
    ...
    public partial class FiscalYearMaintenanceV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.fsyrCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaFsyrCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVFSYR_LAST_PERIOD
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.lastPeriod", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.eoyAccrStatusInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
