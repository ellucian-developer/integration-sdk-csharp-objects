...
namespace Ellucian.Generated.BpApi.Ban.EmployeeJobsDefaultEarningsV100PutRequest
{
    ...
    public partial class EmployeeJobsDefaultEarningsV100PutRequest
    {
        ...
        [Newtonsoft.Json.JsonProperty("criteria.cancelDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? CriteriaCancelDate { get; set; } = default!;
        ...
        /// Lineage reference object : NBREARN_HRS
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.hrs", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaHrs { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : NBREARN_SHIFT
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.shift", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
