...
namespace Ellucian.Generated.BpApi.Ban.DiscountTermsMaintenanceV100PostResponse
{
    ...
    public partial class DiscountTermsMaintenanceV100PostResponse
    {
        /// <summary>
        /// Lineage reference object : FTVDISC_PCT
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pct", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double Pct { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVDISC_END_OF_MONTH_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("endOfMonthInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string EndOfMonthInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("netDays", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? NetDays { get; set; } = default!;
