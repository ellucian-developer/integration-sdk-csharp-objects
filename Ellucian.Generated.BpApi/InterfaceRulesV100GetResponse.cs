...
namespace Ellucian.Generated.BpApi.Ban.InterfaceRulesV100GetResponse
{
    ...
    public partial class InterfaceRulesV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("gtvcmscDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? GtvcmscDesc { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cmscCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CmscCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : STVINFC_TSRC_CODE, Lookup lineage reference object : stvtsrc
        /// </summary>
        [Newtonsoft.Json.JsonProperty("tsrcCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
