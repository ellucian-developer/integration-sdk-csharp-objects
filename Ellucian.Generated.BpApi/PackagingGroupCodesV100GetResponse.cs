...
namespace Ellucian.Generated.BpApi.Ban.PackagingGroupCodesV100GetResponse
{
    ...
    public partial class PackagingGroupCodesV100GetResponse
    {
        /// <summary>
        /// Lineage reference object : RTVPGRP_AWARD_PRIORITY
        /// </summary>
        [Newtonsoft.Json.JsonProperty("awardPriority", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double AwardPriority { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("groupPriority", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double GroupPriority { get; set; } = default!;
