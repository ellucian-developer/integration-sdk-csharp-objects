...
namespace Ellucian.Generated.BpApi.Ban.CurriculaSummaryInstitutionalCoursesV100GetResponse
{
    ...
    public partial class CurriculaSummaryInstitutionalCoursesV100GetResponse
    {
    ...
    {
        [Newtonsoft.Json.JsonProperty("shrtckgGrdeCodeFinal", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ShrtckgGrdeCodeFinal { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shrtckgGmodCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ShrtckgGmodCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shrtcklLevlCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ShrtcklLevlCode { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("shrtckdAppliedInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ShrtckdAppliedInd { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("shrtckgCreditHours", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? ShrtckgCreditHours { get; set; } = default!;
