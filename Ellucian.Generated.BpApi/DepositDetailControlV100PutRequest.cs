...
namespace Ellucian.Generated.BpApi.Ban.DepositDetailControlV100PutRequest
{
    ...
    public partial class DepositDetailControlV100PutRequest
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("criteria.detcDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaDetcDescription { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : TBBDEPC_DETAIL_CODE_PAYMENT, Lookup lineage reference object : tbbdetc
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.detailCodePayment", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
