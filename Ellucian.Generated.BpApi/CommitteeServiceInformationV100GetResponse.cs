...
namespace Ellucian.Generated.BpApi.Ban.CommitteeServiceInformationV100GetResponse
{
    ...
    public partial class CommitteeServiceInformationV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("comiCollDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ComiCollDescription { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("comiDeptDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ComiDeptDescription { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("comiComsDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ComiComsDescription { get; set; } = default!;
