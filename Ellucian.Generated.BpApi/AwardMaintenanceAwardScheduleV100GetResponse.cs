...
namespace Ellucian.Generated.BpApi.Ban.AwardMaintenanceAwardScheduleV100GetResponse
{
    ...
    public partial class AwardMaintenanceAwardScheduleV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("displayRpratrmDeccanAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? DisplayRpratrmDeccanAmt { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("displayRpratrmMemautAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? DisplayRpratrmMemautAmt { get; set; } = default!;
