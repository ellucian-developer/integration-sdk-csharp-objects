...
namespace Ellucian.Generated.BpApi.Ban.ExternalReportTranslationCodesV100GetResponse
{
    ...
    public partial class ExternalReportTranslationCodesV100GetResponse
    {
        /// <summary>
        /// Lineage reference object : FTVEELT_EENT_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("eentCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EentCode { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("internalCodeTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? InternalCodeTitle { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVEELT_EELI_CODE, Lookup lineage reference object : ftveeli
        /// </summary>
        [Newtonsoft.Json.JsonProperty("eeliCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EeliCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("eelcCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EelcCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVEELT_EELT_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("eeltCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EeltCode { get; set; } = default!;
