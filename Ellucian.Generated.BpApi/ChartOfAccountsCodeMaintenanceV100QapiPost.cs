...
namespace Ellucian.Generated.BpApi.Ban.ChartOfAccountsCodeMaintenanceV100QapiPost
{
    ...
    public partial class ChartOfAccountsCodeMaintenanceV100QapiPost
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("methOfAcctg", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("calStartMonth", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CalStartMonth { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVCOAS_CAL_START_DAY
        /// </summary>
        [Newtonsoft.Json.JsonProperty("calStartDay", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CalStartDay { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVCOAS_CAL_END_MONTH
        /// </summary>
        [Newtonsoft.Json.JsonProperty("calEndMonth", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CalEndMonth { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVCOAS_CAL_END_DAY
        /// </summary>
        [Newtonsoft.Json.JsonProperty("calEndDay", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
