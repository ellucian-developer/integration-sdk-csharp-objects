...
namespace Ellucian.Generated.BpApi.Ban.ExistingProgramsV100GetResponse
{
    ...
    public partial class ExistingProgramsV100GetResponse
    {
        [Newtonsoft.Json.JsonProperty("levelCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("levelCodeStudent", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? LevelCodeStudent { get; set; } = default!;
