...
namespace Ellucian.Generated.BpApi.Ban.MealAssignmentV100PutRequest
{
    ...
    public partial class MealAssignmentV100PutRequest
    {
        /// <summary>
        ...
        public object? StatusDate { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.rollInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.arInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaArInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.onlOrBat", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaOnlOrBat { get; set; } = default!;
        ...
        /// Lineage reference object : SLRMASG_MRCD_CODE, Lookup lineage reference object : slrlmfe,tbbdetc
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.mrcdCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaMrcdCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SLRMASG_MSCD_CODE, Lookup lineage reference object : stvmscd
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.mscdCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaMscdCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.assessNeeded", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAssessNeeded { get; set; } = default!;
