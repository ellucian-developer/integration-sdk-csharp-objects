...
namespace Ellucian.Generated.BpApi.Ban.StudentAdjustmentTargetsWaiversSubstitutionsWaiversV100PostRequest
{
    ...
    public partial class StudentAdjustmentTargetsWaiversSubstitutionsWaiversV100PostRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("smrswavCrseNumb", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SmrswavCrseNumb { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("smrswavSubjCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SmrswavSubjCode { get; set; } = default!;
