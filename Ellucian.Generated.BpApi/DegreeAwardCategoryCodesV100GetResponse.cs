...
namespace Ellucian.Generated.BpApi.Ban.DegreeAwardCategoryCodesV100GetResponse
{
    ...
    public partial class DegreeAwardCategoryCodesV100GetResponse
    {
        /// <summary>
        /// Lineage reference object : STVACAT_NSC_CREDENTIAL_CDE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("nscCredentialCde", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? NscCredentialCde { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("nsldsCredentialCde", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? NsldsCredentialCde { get; set; } = default!;
