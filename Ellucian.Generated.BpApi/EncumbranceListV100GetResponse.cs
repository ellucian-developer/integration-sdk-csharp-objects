...
namespace Ellucian.Generated.BpApi.Ban.EncumbranceListV100GetResponse
{
    ...
    public partial class EncumbranceListV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("pendInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PendInd { get; set; } = default!;
