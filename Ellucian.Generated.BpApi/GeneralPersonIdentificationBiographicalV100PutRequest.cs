...
namespace Ellucian.Generated.BpApi.Ban.GeneralPersonIdentificationBiographicalV100PutRequest
{
    ...
    public partial class GeneralPersonIdentificationBiographicalV100PutRequest
    {
        /// <summary>
        ...
        /// Lineage reference object : GORPRAC_RACE_CDE, Lookup lineage reference object : gorrace
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gorpracRaceCde", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string GorpracRaceCde { get; set; } = default!;
