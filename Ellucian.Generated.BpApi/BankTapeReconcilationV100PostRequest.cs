...
namespace Ellucian.Generated.BpApi.Ban.BankTapeReconcilationV100PostRequest
{
    ...
    public partial class BankTapeReconcilationV100PostRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fabbktpInternalDocCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FabbktpInternalDocCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("depCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string DepCode { get; set; } = default!;
