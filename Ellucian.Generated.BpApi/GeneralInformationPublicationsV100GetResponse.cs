...
namespace Ellucian.Generated.BpApi.Ban.GeneralInformationPublicationsV100GetResponse
{
    ...
    public partial class GeneralInformationPublicationsV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("pubtDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PubtDesc { get; set; } = default!;
        ...
        public System.DateTimeOffset? PubDate { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : PPRPUBL_PUBT_CODE, Lookup lineage reference object : ptvpubt
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pubtCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string PubtCode { get; set; } = default!;
