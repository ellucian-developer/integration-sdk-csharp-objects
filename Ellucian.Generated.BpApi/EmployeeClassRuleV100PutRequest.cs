...
namespace Ellucian.Generated.BpApi.Ban.EmployeeClassRuleV100PutRequest
{
    ...
    public partial class EmployeeClassRuleV100PutRequest
    {
        /// <summary>
        /// Lineage reference object : FTVECLS_CONTRACT_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.contractInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaContractInd { get; set; } = default!;
        ...
        /// Lineage reference object : FTVECLS_CONTRACT_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("contractInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ContractInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVECLS_PICT_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.pictCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaPictCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.paysPerYear", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaPaysPerYear { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("budgetRollInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string BudgetRollInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVECLS_HOURS_PER_DAY
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.hoursPerDay", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaHoursPerDay { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVECLS_HOURS_PER_DAY
        /// </summary>
        [Newtonsoft.Json.JsonProperty("hoursPerDay", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double HoursPerDay { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVECLS_BUDGET_ROLL_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.budgetRollInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaBudgetRollInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("hoursPerPay", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double HoursPerPay { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVECLS_HOURS_PER_PAY
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.hoursPerPay", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaHoursPerPay { get; set; } = default!;
