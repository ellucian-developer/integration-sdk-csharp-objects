...
namespace Ellucian.Generated.BpApi.Ban.EmployeeClassRuleV100QapiPost
{
    ...
    public partial class EmployeeClassRuleV100QapiPost
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("budgetRollInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("hoursPerPay", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? HoursPerPay { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVECLS_CONTRACT_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("contractInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
