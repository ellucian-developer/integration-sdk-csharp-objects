...
namespace Ellucian.Generated.BpApi.Ban.ClassAttendanceRosterV100PutRequest
{
    ...
    public partial class ClassAttendanceRosterV100PutRequest
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.attendHr", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaAttendHr { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sfrstcrLastAttend", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? SfrstcrLastAttend { get; set; } = default!;
        ...
        /// Lineage reference object : SFRSTCR_ATTEND_HR
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sfrstcrAttendHr", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? SfrstcrAttendHr { get; set; } = default!;
        ...
        /// Lineage reference object : SFRSTCR_LAST_ATTEND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.lastAttend", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? CriteriaLastAttend { get; set; } = default!;
