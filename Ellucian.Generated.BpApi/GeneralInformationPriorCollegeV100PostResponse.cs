...
namespace Ellucian.Generated.BpApi.Ban.GeneralInformationPriorCollegeV100PostResponse
{
    ...
    public partial class GeneralInformationPriorCollegeV100PostResponse
    {
    ...
    public partial class Sordegr
    {
        ...
        [Newtonsoft.Json.JsonProperty("dlevDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DlevDesc { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("dlev", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? Dlev { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("degcCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
