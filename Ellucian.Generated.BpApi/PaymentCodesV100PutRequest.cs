...
namespace Ellucian.Generated.BpApi.Ban.PaymentCodesV100PutRequest
{
    ...
    public partial class PaymentCodesV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.payTranInd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaPayTranInd { get; set; } = default!;
