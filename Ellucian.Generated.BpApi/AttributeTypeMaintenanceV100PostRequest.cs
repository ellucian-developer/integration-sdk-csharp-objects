...
namespace Ellucian.Generated.BpApi.Ban.AttributeTypeMaintenanceV100PostRequest
{
    ...
    public partial class AttributeTypeMaintenanceV100PostRequest
    {
        /// <summary>
        /// Lineage reference object : FTVATTT_VALID_FUND_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ftvatttValidFundInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FtvatttValidFundInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVATTT_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ftvatttCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string FtvatttCode { get; set; } = default!;
