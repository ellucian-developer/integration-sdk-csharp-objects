...
namespace Ellucian.Generated.BpApi.Ban.CustomerServicesV100GetResponse
{
    ...
    public partial class CustomerServicesV100GetResponse
    {
        /// <summary>
        /// Lineage reference object : TBVCSRV_DETAIL_CODE_DESC
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detailCodeDesc", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string DetailCodeDesc { get; set; } = default!;
