...
namespace Ellucian.Generated.BpApi.Ban.AlternatePersonalIdentificationNumbersV100PutRequest
{
    ...
    public partial class AlternatePersonalIdentificationNumbersV100PutRequest
    {
        /// <summary>
        ...
        /// Lineage reference object : SPRAPIN_PIN
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.pin", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaPin { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SPRAPIN_PROCESS_NAME
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.processName", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaProcessName { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : termCode, Lookup lineage reference object : stvterm
        /// </summary>
        [Newtonsoft.Json.JsonProperty("termCodeKey", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public object? TermCodeKey { get; set; } = default!;
