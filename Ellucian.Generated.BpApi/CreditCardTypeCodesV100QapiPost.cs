...
namespace Ellucian.Generated.BpApi.Ban.CreditCardTypeCodesV100QapiPost
{
    ...
    public partial class CreditCardTypeCodesV100QapiPost
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("editChar", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? EditChar { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : TTVCCRD_MSG_CONTENTS
        /// </summary>
        [Newtonsoft.Json.JsonProperty("msgContents", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
