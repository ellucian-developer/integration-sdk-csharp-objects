...
namespace Ellucian.Generated.BpApi.Ban.CaMisSuccessAndSupportServicesTermDataCounselAdviseV100PostResponse
{
    ...
    public partial class CaMisSuccessAndSupportServicesTermDataCounselAdviseV100PostResponse
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("costCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("costDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CostDesc { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("svvcostNoncreditServiceInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SvvcostNoncreditServiceInd { get; set; } = default!;
