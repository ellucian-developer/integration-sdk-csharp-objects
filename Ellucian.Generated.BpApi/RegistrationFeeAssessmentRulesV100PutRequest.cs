...
namespace Ellucian.Generated.BpApi.Ban.RegistrationFeeAssessmentRulesV100PutRequest
{
    ...
    public partial class RegistrationFeeAssessmentRulesV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.crseWaivInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCrseWaivInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SFRRGFE_MAX_CHARGE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.maxCharge", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaMaxCharge { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.copyInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCopyInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SFRRGFE_RATE_CODE_CURRIC, Lookup lineage reference object : stvrate
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.rateCodeCurric", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaRateCodeCurric { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.stspSessCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaStspSessCode { get; set; } = default!;
        ...
        /// Lineage reference object : SFRRGFE_ENTRY_TYPE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.entryType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaEntryType { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SFRRGFE_PER_CRED_CHARGE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.perCredCharge", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaPerCredCharge { get; set; } = default!;
        ...
        /// Lineage reference object : SFRRGFE_CAMP_CODE_CRSE, Lookup lineage reference object : stvcamp
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.campCodeCrse", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaCampCodeCrse { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.lfstPrimSecCde", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaLfstPrimSecCde { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SFRRGFE_PRIM_SEC_CDE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.primSecCde", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaPrimSecCde { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("criteria.tbbdetcDcatCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaTbbdetcDcatCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.attrCodeCrse", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAttrCodeCrse { get; set; } = default!;
        ...
        /// Lineage reference object : SFRRGFE_LFST_CODE, Lookup lineage reference object : gtvlfst
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.lfstCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaLfstCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SFRRGFE_MIN_CHARGE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.minCharge", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaMinCharge { get; set; } = default!;
        ...
        /// Lineage reference object : SFRRGFE_DETL_CODE, Lookup lineage reference object : tbbdetc
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.detlCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaDetlCode { get; set; } = default!;
        ...
        /// Lineage reference object : SFRRGFE_MAJR_CODE, Lookup lineage reference object : stvmajr
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.majrCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// Lineage reference object : SFRRGFE_STYP_CODE_CURRIC, Lookup lineage reference object : stvstyp
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.stypCodeCurric", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaStypCodeCurric { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.stspResdCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaStspResdCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SFRRGFE_LEVL_CODE_CRSE, Lookup lineage reference object : stvlevl
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.levlCodeCrse", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaLevlCodeCrse { get; set; } = default!;
