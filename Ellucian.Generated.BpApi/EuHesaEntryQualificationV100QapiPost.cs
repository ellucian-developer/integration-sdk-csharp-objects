...
namespace Ellucian.Generated.BpApi.Ban.EuHesaEntryQualificationV100QapiPost
{
    ...
    public partial class EuHesaEntryQualificationV100QapiPost
    {
        ...
        public string? KeyblockEngagementNum { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("entryqualAwardedId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public string? QualificationYear { get; set; } = default!;
