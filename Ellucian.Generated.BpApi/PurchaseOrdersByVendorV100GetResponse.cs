...
namespace Ellucian.Generated.BpApi.Ban.PurchaseOrdersByVendorV100GetResponse
{
    ...
    public partial class PurchaseOrdersByVendorV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("stndPoAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? StndPoAmt { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("displayPoDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? DisplayPoDate { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("regPoQuantity", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? RegPoQuantity { get; set; } = default!;
