...
namespace Ellucian.Generated.BpApi.Ban.AccountIndexCodeMaintenanceV100PostResponse
{
    ...
    public partial class AccountIndexCodeMaintenanceV100PostResponse
    {
        /// <summary>
        /// Lineage reference object : FTVACCI_LOCN_OVERRIDE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("locnOverride", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? LocnOverride { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("actvOverride", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ActvOverride { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("fundCodeTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FundCodeTitle { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("actvCodeTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ActvCodeTitle { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("orgnCodeTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OrgnCodeTitle { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVACCI_ACCT_OVERRIDE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("acctOverride", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AcctOverride { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVACCI_PROG_OVERRIDE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("progOverride", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ProgOverride { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVACCI_ACCI_CODE, Lookup lineage reference object : ftvacci
        /// </summary>
        [Newtonsoft.Json.JsonProperty("acciCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("acctCodeTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AcctCodeTitle { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("locnCodeTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? LocnCodeTitle { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FTVACCI_ORGN_OVERRIDE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("orgnOverride", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OrgnOverride { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fundOverride", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FundOverride { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("progCodeTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ProgCodeTitle { get; set; } = default!;
