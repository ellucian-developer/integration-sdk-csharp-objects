...
namespace Ellucian.Generated.BpApi.Ban.PositionBudgetFringeBenefitV100PutRequest
{
    ...
    public partial class PositionBudgetFringeBenefitV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.expend", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaExpend { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : NBRFTOT_BDCA_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.bdcaCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaBdcaCode { get; set; } = default!;
