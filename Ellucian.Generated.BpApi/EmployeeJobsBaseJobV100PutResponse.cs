...
namespace Ellucian.Generated.BpApi.Ban.EmployeeJobsBaseJobV100PutResponse
{
    ...
    public partial class EmployeeJobsBaseJobV100PutResponse
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("deferBal", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? DeferBal { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : NBRBJOB_FRINGE_ENCUMBRANCE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fringeEncumbrance", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? FringeEncumbrance { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("totalFringeEnc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? TotalFringeEnc { get; set; } = default!;
