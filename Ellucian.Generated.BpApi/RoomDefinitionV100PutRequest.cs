...
namespace Ellucian.Generated.BpApi.Ban.RoomDefinitionV100PutRequest
{
    ...
    public partial class RoomDefinitionV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.utilityRatePeriod", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaUtilityRatePeriod { get; set; } = default!;
        ...
        /// Lineage reference object : SLBRDEF_PHONE_EXTENSION
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.phoneExtension", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaPhoneExtension { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.capacity", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaCapacity { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.utilityRate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaUtilityRate { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SLBRDEF_TERM_CODE_EFF, Lookup lineage reference object : stvterm
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.termCodeEff", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// Lineage reference object : SLBRDEF_BCAT_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.bcatCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaBcatCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SLBRDEF_KEY_NUMBER
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.keyNumber", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaKeyNumber { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.rrcdCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaRrcdCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SLBRDEF_PRCD_CODE, Lookup lineage reference object : stvprcd
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.prcdCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaPrcdCode { get; set; } = default!;

        /// <summary>
        /// Lookup lineage reference object : gtvpars
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.partitionCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaPartitionCode { get; set; } = default!;
        ...
        /// Lineage reference object : SLBRDEF_ROOM_TYPE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.roomType", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaRoomType { get; set; } = default!;
        ...
        /// Lineage reference object : SLBRDEF_RMST_CODE, Lookup lineage reference object : stvrmst
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.rmstCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaRmstCode { get; set; } = default!;
        ...
        /// Lineage reference object : SLBRDEF_SEX
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.sex", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSex { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SLBRDEF_MAXIMUM_CAPACITY
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.maximumCapacity", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaMaximumCapacity { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SLBRDEF_AREA
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.area", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? CriteriaArea { get; set; } = default!;
