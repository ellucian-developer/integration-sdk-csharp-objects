...
namespace Ellucian.Generated.BpApi.Ban.PriorCollegePriorCollegeAndDegreeV100PostResponse
{
    ...
    public partial class PriorCollegePriorCollegeAndDegreeV100PostResponse
    {
    ...
    public partial class Sordegr
    {
        ...
        [Newtonsoft.Json.JsonProperty("degrDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DegrDesc { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("honrDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? HonrDesc { get; set; } = default!;
    ...
    public partial class Sorpcol
    {
        ...
        [Newtonsoft.Json.JsonProperty("epsCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? EpsCode { get; set; } = default!;
