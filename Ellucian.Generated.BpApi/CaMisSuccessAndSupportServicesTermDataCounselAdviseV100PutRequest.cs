...
namespace Ellucian.Generated.BpApi.Ban.CaMisSuccessAndSupportServicesTermDataCounselAdviseV100PutRequest
{
    ...
    public partial class CaMisSuccessAndSupportServicesTermDataCounselAdviseV100PutRequest
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.svvcostNoncreditServiceInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSvvcostNoncreditServiceInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.costCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaCostCode { get; set; } = default!;
