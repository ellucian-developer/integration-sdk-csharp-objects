...
namespace Ellucian.Generated.BpApi.Ban.AddressTypeCodesV100GetResponse
{
    ...
    public partial class AddressTypeCodesV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("teleDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TeleDesc { get; set; } = default!;
