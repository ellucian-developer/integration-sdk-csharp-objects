...
namespace Ellucian.Generated.BpApi.Ban.FinancialAidHoldTypeCodesV100GetResponse
{
    ...
    public partial class FinancialAidHoldTypeCodesV100GetResponse
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("stateAidInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? StateAidInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : RTVHOLD_TITLE_IV_AID_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("titleIvAidInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TitleIvAidInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : RTVHOLD_FEDERAL_AID_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("federalAidInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FederalAidInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("allAidInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AllAidInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : RTVHOLD_INST_AID_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("instAidInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? InstAidInd { get; set; } = default!;
