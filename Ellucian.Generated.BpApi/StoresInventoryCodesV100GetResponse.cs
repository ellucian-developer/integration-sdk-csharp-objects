...
namespace Ellucian.Generated.BpApi.Ban.StoresInventoryCodesV100GetResponse
{
    ...
    public partial class StoresInventoryCodesV100GetResponse
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("displayFtvcommDesc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DisplayFtvcommDesc { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("uomsCodeIssd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? UomsCodeIssd { get; set; } = default!;
