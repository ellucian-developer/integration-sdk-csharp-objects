...
namespace Ellucian.Generated.BpApi.Ban.CurriculumMappingV100QapiPost
{
    ...
    public partial class CurriculumMappingV100QapiPost
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("admitCategoryCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AdmitCategoryCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SKRPOFR_ADMIT_COURSE_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("admitCourseCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("enforceLapseDateInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
