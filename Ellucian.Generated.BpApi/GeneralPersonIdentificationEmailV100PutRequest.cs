...
namespace Ellucian.Generated.BpApi.Ban.GeneralPersonIdentificationEmailV100PutRequest
{
    ...
    public partial class GeneralPersonIdentificationEmailV100PutRequest
    {
        /// <summary>
        ...
        /// Lineage reference object : GOREMAL_EMAIL_ADDRESS
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.emailAddress", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaEmailAddress { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GOREMAL_EMAL_CODE, Lookup lineage reference object : gtvemal
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.emalCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaEmalCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : GOREMAL_PREFERRED_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.preferredInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaPreferredInd { get; set; } = default!;
