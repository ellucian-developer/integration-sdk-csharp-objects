...
namespace Ellucian.Generated.BpApi.Ban.AccountTypeCodeMaintenanceV100PostResponse
{
    ...
    public partial class AccountTypeCodeMaintenanceV100PostResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("predecessorTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PredecessorTitle { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("atypCodePred", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AtypCodePred { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("internalAtypTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? InternalAtypTitle { get; set; } = default!;
