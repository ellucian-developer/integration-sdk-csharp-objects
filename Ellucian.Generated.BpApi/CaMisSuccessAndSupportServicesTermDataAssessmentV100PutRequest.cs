...
namespace Ellucian.Generated.BpApi.Ban.CaMisSuccessAndSupportServicesTermDataAssessmentV100PutRequest
{
    ...
    public partial class CaMisSuccessAndSupportServicesTermDataAssessmentV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.svvasstNoncreditServiceInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSvvasstNoncreditServiceInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.asstCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaAsstCode { get; set; } = default!;
        ...
        /// Lineage reference object : SVRASMT_ASST_CODE, Lookup lineage reference object : svvasst
        /// </summary>
        [Newtonsoft.Json.JsonProperty("svrasmtAsstCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SvrasmtAsstCode { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("svrasmtId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SvrasmtId { get; set; } = default!;
