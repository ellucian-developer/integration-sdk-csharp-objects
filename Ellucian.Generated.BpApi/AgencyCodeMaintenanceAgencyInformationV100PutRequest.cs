...
namespace Ellucian.Generated.BpApi.Ban.AgencyCodeMaintenanceAgencyInformationV100PutRequest
{
    ...
    public partial class AgencyCodeMaintenanceAgencyInformationV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.contactPhoneExt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaContactPhoneExt { get; set; } = default!;
        ...
        /// Lineage reference object : FTVAGCY_CONTACT_EMAIL
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.contactEmail", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaContactEmail { get; set; } = default!;
        ...
        /// Lineage reference object : FTVAGCY_CONTACT_PHONE_AREA
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.contactPhoneArea", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaContactPhoneArea { get; set; } = default!;
        ...
        /// Lineage reference object : FTVAGCY_CONTACT_PHONE_NUMBER
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.contactPhoneNumber", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaContactPhoneNumber { get; set; } = default!;
