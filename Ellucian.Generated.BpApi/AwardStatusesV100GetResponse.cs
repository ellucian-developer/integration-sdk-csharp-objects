...
namespace Ellucian.Generated.BpApi.Ban.AwardStatusesV100GetResponse
{
    ...
    public partial class AwardStatusesV100GetResponse
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("acceptInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AcceptInd { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("offerInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OfferInd { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : RTVAWST_DECLINE_IND
        /// </summary>
        [Newtonsoft.Json.JsonProperty("declineInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DeclineInd { get; set; } = default!;
