...
namespace Ellucian.Generated.BpApi.Ban.ApplicationQuestionsOrAnswersV100PutRequest
{
    ...
    public partial class ApplicationQuestionsOrAnswersV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.displayWebInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaDisplayWebInd { get; set; } = default!;
        ...
        /// Lineage reference object : SARQUAN_QUESTION
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.question", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// Lineage reference object : SARQUAN_ANSWER
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.answer", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaAnswer { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SARQUAN_LONG_ANSWER
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.longAnswer", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaLongAnswer { get; set; } = default!;
