...
namespace Ellucian.Generated.BpApi.Ban.RoomAssignmentStatusV100PutRequest
{
    ...
    public partial class RoomAssignmentStatusV100PutRequest
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.ascdCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CriteriaAscdCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.refund", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double CriteriaRefund { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : SLRRFCR_ASCD_CODE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("criteria.slrrfcrAscdCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CriteriaSlrrfcrAscdCode { get; set; } = default!;
