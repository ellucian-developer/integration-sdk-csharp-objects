...
namespace Ellucian.Generated.BpApi.Ban.ExemptionAuthorizationDetailCodeLevelAuthorizationV100GetResponse
{
    ...
    public partial class ExemptionAuthorizationDetailCodeLevelAuthorizationV100GetResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("tbredet", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Tbredet>? Tbredet { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("tbredsi", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Tbredsi>? Tbredsi { get; set; } = default!;
    ...
    public partial class Tbredet
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("detailPriority", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double DetailPriority { get; set; } = default!;
