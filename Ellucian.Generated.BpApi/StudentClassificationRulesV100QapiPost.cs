...
namespace Ellucian.Generated.BpApi.Ban.StudentClassificationRulesV100QapiPost
{
    ...
    public partial class StudentClassificationRulesV100QapiPost
    {
        ...
        [Newtonsoft.Json.JsonProperty("fromHours", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? FromHours { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("toHours", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
