...
namespace Ellucian.Generated.BpApi.Ban.PurchaseOrderCommodityAccountingV100GetResponse
{
    ...
    public partial class PurchaseOrderCommodityAccountingV100GetResponse
    {
        [Newtonsoft.Json.JsonProperty("fprpodt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Fprpodt>? Fprpodt { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("fprpoda", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Fprpoda>? Fprpoda { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class Fprpodt
    {
        [Newtonsoft.Json.JsonProperty("suppFtvshipFloor", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SuppFtvshipFloor { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("parkAgreCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ParkAgreCode { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("agreCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AgreCode { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FPRPODT_VEND_REF_NUM
        /// </summary>
        [Newtonsoft.Json.JsonProperty("vendRefNum", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? VendRefNum { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("commNote", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CommNote { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("itemX", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ItemX { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("suppFtvshipBuilding", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SuppFtvshipBuilding { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("displayMinQty", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? DisplayMinQty { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("suppShipAddrLine1", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SuppShipAddrLine1 { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("suppShipAddrLine2", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SuppShipAddrLine2 { get; set; } = default!;

        /// <summary>
        /// Lineage reference object : FPRPODT_TEXT_USAGE
        /// </summary>
        [Newtonsoft.Json.JsonProperty("textUsage", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TextUsage { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("suppContact", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SuppContact { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("addCommInd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AddCommInd { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("suppShipAddrLine3", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SuppShipAddrLine3 { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("suppShipAddrLine4", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? SuppShipAddrLine4 { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("liNote", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? LiNote { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("displayExtendedAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? DisplayExtendedAmt { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("displayAgreTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DisplayAgreTitle { get; set; } = default!;

        [Newtonsoft.Json.JsonProperty("displayAgrePrice", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? DisplayAgrePrice { get; set; } = default!;
    ...
    public partial class Fprpoda
    {
        ...
        [Newtonsoft.Json.JsonProperty("displayActgNetAmt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? DisplayActgNetAmt { get; set; } = default!;
