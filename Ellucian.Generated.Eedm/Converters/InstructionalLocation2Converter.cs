...
namespace Ellucian.Generated.Eedm.Converters
{
    ...
    /// </summary>
    public class InstructionalLocation2Converter : JsonConverter
    {
        /// <summary>
        /// JSON read method
        /// </summary>
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            if (objectType.Name != "InstructionalLocation2") return null;
            try
            {
                ...
                if (String.IsNullOrEmpty(instructionalLocationtype))
                    ...
                    return new InstructionalRoom2() { LocationType = null };

                switch (instructionalLocationtype.ToLower())
                {
                    case "site":
                        obj = jObject.ToObject<InstructionalSite2>(serializer);
                        break;
                    case "room":
                        obj = jObject.ToObject<InstructionalRoom2>(serializer);
                        break;
                    case "online":
                        obj = jObject.ToObject<InstructionalOnline2>(serializer);
                        break;
                    case "other":
                        obj = jObject.ToObject<InstructionalOtherLocation2>(serializer);
                        break;
                    default:
                        // return null;
                        return new InstructionalRoom2() { LocationType = null };
