...
namespace Ellucian.Generated.Eedm
{
    ...
    /// </summary>
    [DataContract]
    public class GeneralLedgerDetailDtoProperty3
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("budgetPeriod", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public GuidObject2 BudgetPeriod { get; set; }
        ...
        public decimal? GiftUnits { get; set; }

        /// <summary>
        /// The number of gift units associated with the transaction.
        /// </summary>
        [JsonProperty("encumbrance", DefaultValueHandling = DefaultValueHandling.Ignore, NullValueHandling = NullValueHandling.Ignore)]
