...
namespace Ellucian.Generated.Eedm.CommunicationActivityEfforts_V1_0_0
{
    ...
    public partial class CommunicationActivityEfforts_V1_0_0
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("contactPreferenceType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public ContactPreferenceType? ContactPreferenceType { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("appealGoals", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public AppealGoals? AppealGoals { get; set; } = default!;
    ...
    {
        /// <summary>
        /// The global identifier for the Contact Preference Type.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Guid Id { get; set; } = default!;
    ...
    {
        /// <summary>
        /// The global identifier for the Channel.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Guid Id { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AppealGoals
    {
        /// <summary>
        /// The desired amount of funds to be raised by the appeal.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fundRaising", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public FundRaising? FundRaising { get; set; } = default!;

        /// <summary>
        /// The number of individual contributions that is desired for the appeal.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("contributionCount", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? ContributionCount { get; set; } = default!;

        /// <summary>
        /// The number of individual donors that is desired for the appeal.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("donorCount", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? DonorCount { get; set; } = default!;
    ...
    public partial class FundRaising
    {
        ...
        [Newtonsoft.Json.JsonProperty("currency", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public FundRaisingCurrency Currency { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum FundRaisingCurrency
    {
