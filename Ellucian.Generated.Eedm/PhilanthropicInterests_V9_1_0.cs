...
namespace Ellucian.Generated.Eedm.PhilanthropicInterests_V9_1_0
{
    ...
    public partial class PhilanthropicInterests_V9_1_0
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("philanthropyAmount", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public PhilanthropyAmount? PhilanthropyAmount { get; set; } = default!;

        /// <summary>
        /// The date when the constituent is known to have supported the area of interest.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("contributedOn", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("philanthropyRecipient", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? PhilanthropyRecipient { get; set; } = default!;
    ...
    /// <summary>
    /// A person for whom an interest is identified.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    {
        /// <summary>
        /// The global identifier for the Interest Type.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Guid Id { get; set; } = default!;
    ...
    {
        /// <summary>
        /// The global identifier for the Interest Purpose.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Guid Id { get; set; } = default!;
    ...
    {
        /// <summary>
        /// The global identifier for the Interest Level.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Guid Id { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class PhilanthropyAmount
    {
        /// <summary>
        /// The monetary value
        /// </summary>
        ...
        public PhilanthropyAmountCurrency Currency { get; set; } = default!;
    ...
    {
        /// <summary>
        /// The global identifier for the Organization Type.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Guid Id { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum PhilanthropyAmountCurrency
    {
