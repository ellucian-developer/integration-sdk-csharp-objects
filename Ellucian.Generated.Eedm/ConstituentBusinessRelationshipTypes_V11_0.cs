...
namespace Ellucian.Generated.Eedm.ConstituentBusinessRelationshipTypes_V11_0
{
    ...
    public partial class ConstituentBusinessRelationshipTypes_V11_0
    {
        /// <summary>
        ...
        public ConstituentBusinessRelationshipTypes_V11_0Category Category { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public Authority? Authority { get; set; } = default!;

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum ConstituentBusinessRelationshipTypes_V11_0Category
    {

        [System.Runtime.Serialization.EnumMember(Value = @"organizational")]
        Organizational = 0,

        [System.Runtime.Serialization.EnumMember(Value = @"employmentInclude")]
        EmploymentInclude = 1,

        [System.Runtime.Serialization.EnumMember(Value = @"employmentExclude")]
        EmploymentExclude = 2,
