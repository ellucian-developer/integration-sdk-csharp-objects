...
{
    /// <summary>
    /// The portion (or percentage) of the distribution amount or quantity allocated to the accounting string.
    /// </summary>
    [DataContract]
    public class BlanketPurchaseOrdersAllocatedDtoProperty
    {
        /// <summary>
