...
namespace Ellucian.Generated.Eedm.DfeApplicationSubmissionProcess_V1_2_0
{
    ...
    public partial class DfeApplicationSubmissionProcess_V1_2_0
    {
        /// <summary>
    ...
    public partial class Attribute
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("offerDeferredAt", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? OfferDeferredAt { get; set; } = default!;

        /// <summary>
        /// The status of the application before deferral.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("statusBeforeDeferral", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? StatusBeforeDeferral { get; set; } = default!;

        /// <summary>
        /// The recruitment cycle year a deferred application can be confirmed.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("deferredToRecruitmentCycleYear", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DeferredToRecruitmentCycleYear { get; set; } = default!;
        ...
        /// Array Of Interviews
        /// </summary>
        [Newtonsoft.Json.JsonProperty("interviews", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Interviews>? Interviews { get; set; } = default!;
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("withdrawnOrDeclinedForCandidate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? WithdrawnOrDeclinedForCandidate { get; set; } = default!;
    ...
    public partial class Interviews
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("interviewDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("cancelledOn", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
