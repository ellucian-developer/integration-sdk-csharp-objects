...
namespace Ellucian.Generated.Eedm
{
    ...
    public class SectionMaximum_V6_0
    {
        /// <summary>
        ...
        public AcademicPeriodDtoProperty AcademicPeriod { get; set; }
        ...
        /// Owning Organizations for the section
        /// </summary>
        [JsonProperty("awardGradeSchemes", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public IEnumerable<GradeSchemeDtoProperty> AwardGradeSchemes { get; set; }

        /// <summary>
        /// Owning Organizations for the section
        /// </summary>
        [JsonProperty("transcriptGradeSchemes", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public IEnumerable<GradeSchemeDtoProperty> TranscriptGradeSchemes { get; set; }

        /// <summary>
        /// InstructionalEvents for the section
        /// </summary>
        [JsonProperty("instructionalEvents", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public IEnumerable<InstructionalEventDtoProperty> InstructionalEvents { get; set; }

        /// <summary>
        /// Contructor
        /// </summary>
        [JsonConstructor]
        public SectionMaximum_V6_0() : base()
        {
