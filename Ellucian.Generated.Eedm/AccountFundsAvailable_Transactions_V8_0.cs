...
namespace Ellucian.Generated.Eedm
{
    ...
    public class AccountFundsAvailable_Transactions_V8_0
    {
        /// <summary>
        ...
        public List<AccountFundsAvailable_Transactionstransactions> Transactions { get; set; }
    ...
    /// </summary>
    [JsonObject(MemberSerialization.OptIn)]
    public class AccountFundsAvailable_Transactionstransactions
    {
        ...
        public List<AccountFundsAvailable_TransactionstransactionDetailLines> TransactionDetailLines { get; set; }
    ...
    /// </summary>
    [JsonObject(MemberSerialization.OptIn)]
    public class AccountFundsAvailable_TransactionstransactionDetailLines
    {
        /// <summary>
