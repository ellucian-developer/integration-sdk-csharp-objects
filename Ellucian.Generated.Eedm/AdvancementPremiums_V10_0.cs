...
namespace Ellucian.Generated.Eedm.AdvancementPremiums_V10_0
{
    ...
    public partial class AdvancementPremiums_V10_0
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("lifetimeMaximumAwardable", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? LifetimeMaximumAwardable { get; set; } = default!;

        /// <summary>
        /// The minimum number of months between subsequent assignments of the premium to the same constituent.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("monthsBetweenAssignments", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? MonthsBetweenAssignments { get; set; } = default!;
